...
class Woo_Products extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'query_type',
			[
				'label'   		=> __( 'Source', 'sunio' ),
				'type'    		=> Controls_Manager::SELECT,
				'default' 		=> 'all',
				'options' 		=> [
					'all'    => __( 'All Products', 'sunio' ),
					'custom' => __( 'Custom Query', 'sunio' ),
					'manual' => __( 'Manual Selection', 'sunio' ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label'     	=> __( 'Cat Filter Rule', 'sunio' ),
				'type'      	=> Controls_Manager::SELECT,
				'default'   	=> 'IN',
				'options'   	=> [
					'IN'     => __( 'Match Categories', 'sunio' ),
					'NOT IN' => __( 'Exclude Categories', 'sunio' ),
				],
				'condition' 	=> [
					'query_type' => 'custom',
				],
		...
		$this->add_control(
			'tag_filter_rule',
			[
				'label'     	=> __( 'Tag Filter Rule', 'sunio' ),
				'type'      	=> Controls_Manager::SELECT,
				'default'   	=> 'IN',
				'options'   	=> [
					'IN'     => __( 'Match Tags', 'sunio' ),
					'NOT IN' => __( 'Exclude Tags', 'sunio' ),
				],
				'condition' 	=> [
					'query_type' => 'custom',
				],
		...
		$this->add_control(
			'offset',
			[
				'label'       	=> __( 'Offset', 'sunio' ),
				'type'        	=> Controls_Manager::NUMBER,
				'default'     	=> 0,
				'description' 	=> __( 'Number of post to displace or pass over.', 'sunio' ),
				'condition'   	=> [
					'query_type' => 'custom',
				],
			]
		...
		$this->add_control(
			'query_manual_ids',
			[
				'label'     	=> __( 'Select Products', 'sunio' ),
				'type'      	=> 'azt-query-posts',
				'post_type' 	=> 'product',
				'multiple'  	=> true,
				'condition'	 => [
					'query_type' => 'manual',
		...
		$this->add_control(
			...
			[
				...
				'post_type'   	=> 'product',
				'multiple'    	=> true,
				'description' 	=> __( 'Select products to exclude from the query.', 'sunio' ),
				'condition'   	=> [
					'query_type!' => 'manual',
				],
			]
		...
		$this->add_control(
			...
			[
				'label'        	=> __( 'Exclude Current Product', 'sunio' ),
				'type'         	=> Controls_Manager::SWITCHER,
				'label_on'     	=> __( 'Yes', 'sunio' ),
				'label_off'    	=> __( 'No', 'sunio' ),
				'return_value' 	=> 'yes',
				'default'      	=> '',
				'description'  	=> __( 'Enable this option to remove current product from the query.', 'sunio' ),
				'condition'    	=> [
					'query_type!' => 'manual',
				],
			]
