...
// Get ID
$get_id = get_theme_mod( 'sunio_error_page_template' );

// Check if page is Elementor page
$elementor  = get_post_meta( $get_id, '_elementor_edit_mode', true );

// Get content
$get_content = sunio_error_page_template_content();

// If blank page
if ( 'on' == get_theme_mod( 'sunio_error_page_blank', 'off' ) ) { ?>

	<!DOCTYPE html>
	<html <?php language_attributes(); ?><?php sunio_schema_markup( 'html' ); ?>>
		<head>
		...
		<!-- Begin Body -->
		<body <?php body_class(); ?><?php sunio_schema_markup( 'body' ); ?>>
										...
										if ( ! function_exists( 'elementor_theme_do_location' ) || ! elementor_theme_do_location( 'single' ) ) {
									        ...
									        if ( ! empty( $get_id ) ) {
											    ...
											    if ( sunio_ELEMENTOR_ACTIVE && $elementor ) {
											        ...
											        sunio_Elementor::get_error_page_content();
										    ...
										    // Else
										    	...
										    	<div class="error404-content clr">
													...
													<h2 class="error-title"><?php esc_html_e( 'This page could not be found!', 'sunio' ) ?></h2>
													<p class="error-text"><?php esc_html_e( 'We are sorry. But the page you are looking for is not available.', 'sunio' ); ?><br /><?php esc_html_e( 'Perhaps you can try a new search.', 'sunio' ); ?></p>
													<?php get_search_form(); ?>
													<a class="error-btn button" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Back To Homepage', 'sunio' ) ?></a>
