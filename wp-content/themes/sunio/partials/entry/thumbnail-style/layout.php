...
$classes = sunio_post_entry_classes();

// Inner classes
$inner_classes = array(); 

// Image position
$position = get_theme_mod( 'sunio_blog_thumbnail_image_position', 'left' );
$position = $position ? $position : 'left';
$inner_classes[] = $position . '-position';

// Vertical postion
$ver_position = get_theme_mod( 'sunio_blog_thumbnail_vertical_position', 'center' );
