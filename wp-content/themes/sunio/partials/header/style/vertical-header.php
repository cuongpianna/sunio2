...
// Get template
$template = get_theme_mod( 'sunio_vertical_header_template' );
...
// Get bottom template
$bottom_template = get_theme_mod( 'sunio_vertical_header_bottom_template' );
...
<div id="site-header-inner" class="<?php echo esc_attr( $classes ); ?>">
    ...
    if ( ! empty( $template ) ) {
        ...
        if ( sunio_ELEMENTOR_ACTIVE && $elementor ) {
            ...
            sunio_Elementor::get_vertical_header_content();
        ...
        <?php
        // Search form
        if ( true == get_theme_mod( 'sunio_vertical_header_search_form', true ) ) {
        ...
        if ( ! empty( $bottom_template ) ) {
            ...
            // If Elementor
            if ( sunio_ELEMENTOR_ACTIVE && $bottom_elementor ) {

                sunio_Elementor::get_vertical_header_bottom_content();

            }

            // If Beaver Builder
            else if ( sunio_BEAVER_BUILDER_ACTIVE && ! empty( $bottom_template ) ) {
