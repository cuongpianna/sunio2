...
if ( class_exists( 'sunio_Sticky_Header' ) ) {
...
do_action( 'sunio_before_header' );

// If transparent header style
if ( 'transparent' == $header_style
	|| ( 'full_screen' == $header_style && true == get_theme_mod( 'sunio_full_screen_header_transparent', false ) )
...
<header id="site-header" class="<?php echo esc_attr( sunio_header_classes() ); ?>" data-height="<?php echo esc_attr( $header_height ); ?>"<?php sunio_schema_markup( 'header' ); ?>>
	...
	if ( ! function_exists( 'elementor_theme_do_location' ) || ! elementor_theme_do_location( 'header' ) ) { ?>
		...
		// If sunio header style
		else if ( 'sunio' == $header_style ) {
			get_template_part( 'partials/header/style/azt-header' );
		}
		...
		// Default header style
			...
			<div id="site-header-inner" class="clr<?php echo esc_attr( $class ); ?>">
				...
				<?php do_action( 'sunio_header_inner_middle_content' ); ?>
