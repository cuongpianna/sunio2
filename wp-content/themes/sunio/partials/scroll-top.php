...
if ( ! sunio_display_scroll_up_button() ) {
	return;
}

// Get arrow
$arrow = apply_filters( 'sunio_scroll_top_arrow', get_theme_mod( 'sunio_scroll_top_arrow' ) );
$arrow = $arrow ? $arrow : 'fa fa-angle-up'; 

// Position
$position = apply_filters( 'sunio_scroll_top_position', get_theme_mod( 'sunio_scroll_top_position' ) );
