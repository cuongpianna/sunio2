...
// Get meta sections
$sections = sunio_blog_single_meta();
...
<?php do_action( 'sunio_before_single_post_meta' ); ?>
...
<ul class="meta clr">
	...
	foreach ( $sections as $section ) { ?>
		...
		<?php if ( 'comments' == $section && comments_open() && ! post_password_required() ) { ?>
			<li class="meta-comments"><i class="icon-bubble"></i><?php comments_popup_link( esc_html__( '0 Comments', 'sunio' ), esc_html__( '1 Comment',  'sunio' ), esc_html__( '% Comments', 'sunio' ), 'comments-link local' ); ?></li>
		<?php } ?>
...
<?php do_action( 'sunio_after_single_post_meta' ); ?>