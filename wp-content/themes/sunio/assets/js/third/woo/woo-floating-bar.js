( function( $ ) {
    $( document ).scroll( function() {
        ...
        $( '.azt-floating-bar button.button.top' ).on( 'click', function( e ) {
        	e.preventDefault();
	...
	var owpFBAddToCartHandler = function() {
		$( document.body )
			.on( 'click', '.azt-floating-bar .floating_add_to_cart_button', this.onAddToCart )
	...
	owpFBAddToCartHandler.prototype.onAddToCart = function( e ) {
		...
		$.ajax ({
			...
			type:'POST',
			data:'action=sunio_add_cart_floating_bar&product_id=' + product_id + '&quantity=' + quantity,
