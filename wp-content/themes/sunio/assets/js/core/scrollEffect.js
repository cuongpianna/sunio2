	    ...
	    $j( 'a.local[href*="#"]:not([href="#"]), .local a[href*="#"]:not([href="#"]), a.menu-link[href*="#"]:not([href="#"]), a.sidr-class-menu-link[href*="#"]:not([href="#"])' ).on( 'click', function() {
	    	...
	    	if ( ! $j( this ).hasClass( 'omw-open-modal' )
	        	...
	        	var $href     				= $j( this ).attr( 'href' ),
				    ...
				    $target   				= $j( '#' + $hrefHash ),
					$adminbarHeight        	= sunioGetAdminbarHeight(),
					$topbarHeight        	= sunioGetTopbarHeight(),
					$stickyHeaderHeight    	= sunioGetStickyHeaderHeight(),
...
// Admin bar height
function sunioGetAdminbarHeight() {
	"use strict"
...
// Header height
function sunioGetStickyHeaderHeight() {
	"use strict"
