...
<div id="sunio-off-canvas-sidebar-wrap">
	<div class="sunio-off-canvas-sidebar">
		<?php dynamic_sidebar( 'owp_off_canvas_sidebar' ); ?>
		<?php
		if ( true == get_theme_mod( 'sunio_woo_off_canvas_close_button', false ) ) { ?>
    		<button type="button" class="sunio-off-canvas-close">
	...
	<div class="sunio-off-canvas-overlay"></div>
</div>