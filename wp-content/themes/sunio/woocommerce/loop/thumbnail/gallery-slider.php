...
// Get gallery images
if ( version_compare( sunio_WooCommerce_Config::get_wc_version(), '2.7', '>=' ) ) {
...
if ( $attachment_ids ) : ?>
	...
	<div class="product-entry-slider-wrap">
		...
		<?php do_action( 'sunio_before_product_entry_slider' ); ?>

		<div class="product-entry-slider woo-entry-image clr">

			<?php do_action( 'sunio_before_product_entry_image' ); ?>
			...
			<?php do_action( 'sunio_after_product_entry_image' ); ?>

		</div>

		<?php do_action( 'sunio_after_product_entry_slider' ); ?>
