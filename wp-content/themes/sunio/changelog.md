...
* **Added** - New setting in the WooCommerce section of the customizer to allow you to remove all custom features added in the theme for WooCommerce, so you will be able to add your custom features or to make all WooCommerce plugins compatible with sunio.
...
### *2018.06.03* - 1.5.16:
* **Added** - Easy Digital Downloads integration, check the new demo: https://book.sunio.org/ 
* **Tweak** - Moved the WooCommerce Checkout settings in the sunio WooCommerce section in the customizer. 
...
* **Added** - Filter "sunio_default_color_palettes", to allow you to change the default color palettes of the color options in the customizer.
...
* **Added** - sunio is now 100% WooCommerce compatible, so you can use external plugins as WC Vendors without problems.
...
### *2017.11.02* - 1.4.3
* **Added** - Translation with WPML for the custom theme's parts, see this article: http://docs.sunio.org/article/474-translate-custom-parts-of-the-theme-with-wpml
...
* **Tweak** - IMPORTANT, big improvement on the Center header style, if you use this header style, read this article: http://docs.sunio.org/article/467-improvement-on-the-center-header-style
...
### *2017.08.16* - 1.3.4
* **Fixed** - Values of the sunio Settings metabox not saved in the LifterLMS Courses post type.
...
* **Added** - Filter for the meta in the customizer to add your own meta, see this [article](http://docs.sunio.org/article/430-add-your-own-meta).
...
### *2017.03.24* - 1.1.7.3
* **Fixed** - Header issue with the sunio_main_schema_markup() function.
...
### *2017.01.15* - 1.1.2
* **Added** - Script to create modal, check: http://docs.sunio.org/article/356-how-to-create-modal/
...
### *2016.12.20* - 1.1.0
Warning: The name of the theme changed to sunio because Ocean was already taken, WordPress will see the sunio theme as a new theme, so, you need to do a fews steps, look at this video:
...
3. Download the new version of the theme on sunio.org.
...
10. if you use a child theme, replace "wp_get_theme( 'Ocean' )" by "wp_get_theme( 'sunio' )".
...
I'm really sorry for that, there will never be any changes of this kind again, I want the theme to be available in the WordPress directory, and the name Ocean was already taken in the waiting list, so I had to modify it to sunio.
