...
if ( ! class_exists( 'sunio_Social_Login' ) ) :

	class sunio_Social_Login {
		...
		public static function add_custom_css() {
			wp_enqueue_style( 'sunio-wsl', sunio_CSS_DIR_URI .'third/social-login.min.css' );
		}
