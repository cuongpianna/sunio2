<?php
/**
 * Customizer Control: sunio-slider.
 *
 ...
 * Buttonset control
 */
class sunio_Customizer_Slider_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'sunio-slider', sunio_INC_DIR_URI . 'customizer/assets/min/js/slider.min.js', array( 'jquery', 'customize-base', 'jquery-ui-slider' ), false, true );
		wp_enqueue_style( 'sunio-slider', sunio_INC_DIR_URI . 'customizer/assets/min/css/slider.min.css', null );
	}
	...
	protected function content_template() {
		...
		<# if ( data.desktop ) { #>
			<div class="desktop control-wrap active">
				<div class="sunio-slider desktop-slider"></div>
				<div class="sunio-slider-input">
		...
		<# if ( data.tablet ) { #>
			<div class="tablet control-wrap">
				<div class="sunio-slider tablet-slider"></div>
				<div class="sunio-slider-input">
		...
		<# if ( data.mobile ) { #>
			<div class="mobile control-wrap">
				<div class="sunio-slider mobile-slider"></div>
				<div class="sunio-slider-input">
