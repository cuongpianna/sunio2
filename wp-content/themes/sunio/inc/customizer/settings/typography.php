	...
	class sunio_Typography_Customizer {
		...
		public function elements() {
			...
			return apply_filters( 'sunio_typography_settings', array(
				...
				'heading_h1' 				=> array(
					'label' 				=> esc_html__( 'Heading 1 (H1)', 'sunio' ),
					'target' 				=> 'h1',
					'defaults' 				=> array(
						'font-size' 		=> '23px',
						'color' 			=> '#333333',
				...
				'heading_h2' 				=> array(
					'label' 				=> esc_html__( 'Heading 2 (H2)', 'sunio' ),
					'target' 				=> 'h2',
					'defaults' 				=> array(
						'font-size' 		=> '20px',
						'color' 			=> '#333333',
				...
				'heading_h3' 				=> array(
					'label' 				=> esc_html__( 'Heading 3 (H3)', 'sunio' ),
					'target' 				=> 'h3',
					'defaults' 				=> array(
						'font-size' 		=> '18px',
						'color' 			=> '#333333',
				...
				'heading_h4' 				=> array(
					'label' 				=> esc_html__( 'Heading 4 (H4)', 'sunio' ),
					'target' 				=> 'h4',
					'defaults' 				=> array(
						'font-size' 		=> '17px',
						'color' 			=> '#333333',
				...
				'top_menu' 					=> array(
					'label' 				=> esc_html__( 'Top Bar', 'sunio' ),
				...
				'menu' 						=> array(
					'label' 				=> esc_html__( 'Main Menu', 'sunio' ),
				...
				'menu_dropdown' 			=> array(
					'label' 				=> esc_html__( 'Main Menu: Dropdowns', 'sunio' ),
				...
				'page_title' 				=> array(
					'label' 				=> esc_html__( 'Page Title', 'sunio' ),
					...
					'active_callback' 		=> 'sunio_cac_has_page_header',
				),
				'page_subheading' 			=> array(
					'label' 				=> esc_html__( 'Page Title Subheading', 'sunio' ),
				...
				'blog_entry_title' 			=> array(
					'label' 				=> esc_html__( 'Blog Entry Title', 'sunio' ),
				...
				'blog_post_title' 			=> array(
					'label' 				=> esc_html__( 'Blog Post Title', 'sunio' ),
				...
				'sidebar_widget_title' 		=> array(
					'label' 				=> esc_html__( 'Sidebar Widget Heading', 'sunio' ),
				...
				'footer_widget_title' 		=> array(
					'label' 				=> esc_html__( 'Footer Widget Heading', 'sunio' ),
				...
				'copyright' 				=> array(
					'label' 				=> esc_html__( 'Footer Copyright', 'sunio' ),
				...
				'footer_menu' 				=> array(
					'label' 				=> esc_html__( 'Footer Menu', 'sunio' ),
