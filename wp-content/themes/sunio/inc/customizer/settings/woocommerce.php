...
if ( ! class_exists( 'sunio_WooCommerce_Customizer' ) ) :
	...
	class sunio_WooCommerce_Customizer {
		...
		public function customizer_options( $wp_customize ) {
			 ...
			 * Dropdowns Width
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_width', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '350',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );

			$wp_customize->add_control( new sunio_Customizer_Range_Control( $wp_customize, 'sunio_woo_cart_dropdown_width', array(
				'label'	   				=> esc_html__( 'Cart Dropdowns Width (px)', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_width',
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 30,
			        'max'   => 600,
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_bg', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#ffffff',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_bg', array(
				'label'	   				=> esc_html__( 'Dropdown Background Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_bg',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_borders', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#e6e6e6',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_borders', array(
				'label'	   				=> esc_html__( 'Dropdown Borders Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_borders',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Link Color
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_link_color', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#333333',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_link_color', array(
				'label'	   				=> esc_html__( 'Link Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_link_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Link Hover Color
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_link_color_hover', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#13aff0',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_link_color_hover', array(
				'label'	   				=> esc_html__( 'Link Color: Hover', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_link_color_hover',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Remove Link Color
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_remove_link_color', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#b3b3b3',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_remove_link_color', array(
				'label'	   				=> esc_html__( 'Remove Link Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_remove_link_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_remove_link_color_hover', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#13aff0',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_remove_link_color_hover', array(
				'label'	   				=> esc_html__( 'Remove Link Color: Hover', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_remove_link_color_hover',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Quantity Color
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_quantity_color', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#b2b2b2',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_quantity_color', array(
				'label'	   				=> esc_html__( 'Quantity Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_quantity_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Price Color
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_price_color', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#57bf6d',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_price_color', array(
				'label'	   				=> esc_html__( 'Price Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_price_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Subtotal Color
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_subtotal_bg', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#fafafa',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_subtotal_bg', array(
				'label'	   				=> esc_html__( 'Subtotal Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_subtotal_bg',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Subtotal Color
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_subtotal_color', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#797979',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_subtotal_color', array(
				'label'	   				=> esc_html__( 'Subtotal Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_subtotal_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Total Price Color
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_total_price_color', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#57bf6d',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_total_price_color', array(
				'label'	   				=> esc_html__( 'Total Price Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_total_price_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_cart_button_bg', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_cart_button_bg', array(
				'label'	   				=> esc_html__( 'Cart Button Background', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_cart_button_bg',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_cart_button_hover_bg', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_cart_button_hover_bg', array(
				'label'	   				=> esc_html__( 'Cart Button Background: Hover', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_cart_button_hover_bg',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Cart Button: Color
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_cart_button_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_cart_button_color', array(
				'label'	   				=> esc_html__( 'Cart Button Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_cart_button_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_cart_button_hover_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_cart_button_hover_color', array(
				'label'	   				=> esc_html__( 'Cart Button Color: Hover', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_cart_button_hover_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_cart_button_border_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_cart_button_border_color', array(
				'label'	   				=> esc_html__( 'Cart Button Border Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_cart_button_border_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_cart_button_hover_border_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_cart_button_hover_border_color', array(
				'label'	   				=> esc_html__( 'Cart Button Border Color: Hover', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_cart_button_hover_border_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_checkout_button_bg', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_checkout_button_bg', array(
				'label'	   				=> esc_html__( 'Checkout Button Background', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_checkout_button_bg',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_checkout_button_hover_bg', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_checkout_button_hover_bg', array(
				'label'	   				=> esc_html__( 'Checkout Button Background: Hover', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_checkout_button_hover_bg',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_checkout_button_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_checkout_button_color', array(
				'label'	   				=> esc_html__( 'Checkout Button Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_checkout_button_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_cart_dropdown_checkout_button_hover_color', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_cart_dropdown_checkout_button_hover_color', array(
				'label'	   				=> esc_html__( 'Checkout Button Color: Hover', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_cart_dropdown_checkout_button_hover_color',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Heading Styling
			 */
			$wp_customize->add_setting( 'sunio_woo_mobile_cart_styling_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_woo_mobile_cart_styling_heading', array(
				'label'    	=> esc_html__( 'Mobile Cart Sidebar Styling', 'sunio' ),
				'section'  	=> 'sunio_woocommerce_menu_cart',
				'priority' 	=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_mobile_cart_sidebar_bg', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '#ffffff',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_mobile_cart_sidebar_bg', array(
				'label'	   				=> esc_html__( 'Background Color', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_menu_cart',
				'settings' 				=> 'sunio_woo_mobile_cart_sidebar_bg',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_mobile_cart_sidebar_close_button_color', array(
				'default'				=> '#000000',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_mobile_cart_sidebar_close_button_color', array(
				'label'					=> esc_html__( 'Close Button Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_menu_cart',
				'settings'				=> 'sunio_woo_mobile_cart_sidebar_close_button_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_mobile_cart_sidebar_title_color', array(
				'default'				=> '#555555',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_mobile_cart_sidebar_title_color', array(
				'label'					=> esc_html__( 'Title Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_menu_cart',
				'settings'				=> 'sunio_woo_mobile_cart_sidebar_title_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_mobile_cart_sidebar_divider_color', array(
				'default'				=> 'rgba(0,0,0,0.1)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_mobile_cart_sidebar_divider_color', array(
				'label'					=> esc_html__( 'Divider Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_menu_cart',
				'settings'				=> 'sunio_woo_mobile_cart_sidebar_divider_color',
				'priority'				=> 10,
			) ) );
			 ...
			 * Section
			 */
			$wp_customize->add_section( 'sunio_woocommerce_styling' , array(
				'title' 				=> esc_html__( 'Advanced Styling', 'sunio' ),
				'priority' 				=> 10,
				'panel' 				=> $panel,
			) );
		     ...
		     * On Sale Background
		     */
	        $wp_customize->add_setting( 'sunio_onsale_bg', array(
				'default'				=> '#3fc387',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_onsale_bg', array(
				'label'					=> esc_html__( 'On Sale Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_onsale_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     * On Sale Color
		     */
	        $wp_customize->add_setting( 'sunio_onsale_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_onsale_color', array(
				'label'					=> esc_html__( 'On Sale Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_onsale_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_outofstock_bg', array(
				'default'				=> '#000000',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_outofstock_bg', array(
				'label'					=> esc_html__( 'Out of Stock Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_outofstock_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     * Out of Stock Color
		     */
	        $wp_customize->add_setting( 'sunio_outofstock_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_outofstock_color', array(
				'label'					=> esc_html__( 'Out of Stock Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_outofstock_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Stars Color Before
		     */
	        $wp_customize->add_setting( 'sunio_stars_color_before', array(
				'default'				=> '#dfdbdf',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_stars_color_before', array(
				'label'					=> esc_html__( 'Stars Color Before', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_stars_color_before',
				'priority'				=> 10,
			) ) );
		     ...
		     * Stars Color
		     */
	        $wp_customize->add_setting( 'sunio_stars_color', array(
				'default'				=> '#f9ca63',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_stars_color', array(
				'label'					=> esc_html__( 'Stars Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_stars_color',
				'priority'				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_product_entry_toolbar_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_product_entry_toolbar_heading', array(
				'label'    				=> esc_html__( 'Product Entry: Toolbar', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_border_color', array(
				'default'				=> '#eaeaea',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_border_color', array(
				'label'					=> esc_html__( 'Border Top/Bottom Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_border_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_off_canvas_filter_color', array(
				'default'				=> '#999999',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_off_canvas_filter_color', array(
				'label'					=> esc_html__( 'Off Canvas Filter Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_off_canvas_filter_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_off_canvas_filter_border_color', array(
				'default'				=> '#eaeaea',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_off_canvas_filter_border_color', array(
				'label'					=> esc_html__( 'Off Canvas Filter Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_off_canvas_filter_border_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_off_canvas_filter_hover_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_off_canvas_filter_hover_color', array(
				'label'					=> esc_html__( 'Off Canvas Filter Hover Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_off_canvas_filter_hover_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_off_canvas_filter_hover_border_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_off_canvas_filter_hover_border_color', array(
				'label'					=> esc_html__( 'Off Canvas Filter Hover Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_off_canvas_filter_hover_border_color',
				'priority'				=> 10
			) ) );
		     ...
		     * Grid/List Color
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_grid_list_color', array(
				'default'				=> '#999999',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_grid_list_color', array(
				'label'					=> esc_html__( 'Grid/List Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_grid_list_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_grid_list_border_color', array(
				'default'				=> '#eaeaea',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_grid_list_border_color', array(
				'label'					=> esc_html__( 'Grid/List Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_grid_list_border_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_grid_list_hover_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_grid_list_hover_color', array(
				'label'					=> esc_html__( 'Grid/List Hover Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_grid_list_hover_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_grid_list_active_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_grid_list_active_color', array(
				'label'					=> esc_html__( 'Grid/List Active Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_grid_list_active_color',
				'priority'				=> 10
			) ) );
		     ...
		     * Select Color
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_select_color', array(
				'default'				=> '#999999',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_select_color', array(
				'label'					=> esc_html__( 'Select Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_select_color',
				'priority'				=> 10
			) ) );
		     ...
		     * Select Border Color
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_select_border_color', array(
				'default'				=> '#dddddd',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_select_border_color', array(
				'label'					=> esc_html__( 'Select Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_select_border_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_number_of_products_color', array(
				'default'				=> '#555555',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_number_of_products_color', array(
				'label'					=> esc_html__( 'Number of Products Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_number_of_products_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_number_of_products_inactive_color', array(
				'default'				=> '#999999',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_number_of_products_inactive_color', array(
				'label'					=> esc_html__( 'Number of Products Inactive Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_number_of_products_inactive_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_toolbar_number_of_products_border_color', array(
				'default'				=> '#999999',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_toolbar_number_of_products_border_color', array(
				'label'					=> esc_html__( 'Number of Products Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_toolbar_number_of_products_border_color',
				'priority'				=> 10
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_product_entry_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_product_entry_heading', array(
				'label'    				=> esc_html__( 'Product Entry', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Product Padding
			 */
			$wp_customize->add_setting( 'sunio_product_top_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_right_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_bottom_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_left_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );

			$wp_customize->add_setting( 'sunio_product_tablet_top_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_tablet_right_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_tablet_bottom_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_tablet_left_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );

			$wp_customize->add_setting( 'sunio_product_mobile_top_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_mobile_right_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_mobile_bottom_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_mobile_left_padding', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );

			$wp_customize->add_control( new sunio_Customizer_Dimensions_Control( $wp_customize, 'sunio_product_padding', array(
				'label'	   				=> esc_html__( 'Padding (px)', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'settings'   => array(
		            'desktop_top' 		=> 'sunio_product_top_padding',
		            'desktop_right' 	=> 'sunio_product_right_padding',
		            'desktop_bottom' 	=> 'sunio_product_bottom_padding',
		            'desktop_left' 		=> 'sunio_product_left_padding',
		            'tablet_top' 		=> 'sunio_product_tablet_top_padding',
		            'tablet_right' 		=> 'sunio_product_tablet_right_padding',
		            'tablet_bottom' 	=> 'sunio_product_tablet_bottom_padding',
		            'tablet_left' 		=> 'sunio_product_tablet_left_padding',
		            'mobile_top' 		=> 'sunio_product_mobile_top_padding',
		            'mobile_right' 		=> 'sunio_product_mobile_right_padding',
		            'mobile_bottom' 	=> 'sunio_product_mobile_bottom_padding',
		            'mobile_left' 		=> 'sunio_product_mobile_left_padding',
				),
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 0,
			 ...
			 */
			$wp_customize->add_setting( 'sunio_product_image_top_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_image_right_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_image_bottom_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_image_left_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );

			$wp_customize->add_setting( 'sunio_product_image_tablet_top_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_image_tablet_right_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_image_tablet_bottom_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_image_tablet_left_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );

			$wp_customize->add_setting( 'sunio_product_image_mobile_top_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_image_mobile_right_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_image_mobile_bottom_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_image_mobile_left_margin', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );

			$wp_customize->add_control( new sunio_Customizer_Dimensions_Control( $wp_customize, 'sunio_product_image_margin', array(
				'label'	   				=> esc_html__( 'Image Margin (px)', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'settings'   => array(
		            'desktop_top' 		=> 'sunio_product_image_top_margin',
		            'desktop_right' 	=> 'sunio_product_image_right_margin',
		            'desktop_bottom' 	=> 'sunio_product_image_bottom_margin',
		            'desktop_left' 		=> 'sunio_product_image_left_margin',
		            'tablet_top' 		=> 'sunio_product_image_tablet_top_margin',
		            'tablet_right' 		=> 'sunio_product_image_tablet_right_margin',
		            'tablet_bottom' 	=> 'sunio_product_image_tablet_bottom_margin',
		            'tablet_left' 		=> 'sunio_product_image_tablet_left_margin',
		            'mobile_top' 		=> 'sunio_product_image_mobile_top_margin',
		            'mobile_right' 		=> 'sunio_product_image_mobile_right_margin',
		            'mobile_bottom' 	=> 'sunio_product_image_mobile_bottom_margin',
		            'mobile_left' 		=> 'sunio_product_image_mobile_left_margin',
				),
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'max'   => 100,
			 ...
			 */
			$wp_customize->add_setting( 'sunio_product_top_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_right_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_bottom_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_left_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );

			$wp_customize->add_setting( 'sunio_product_tablet_top_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_tablet_right_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_tablet_bottom_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_tablet_left_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );

			$wp_customize->add_setting( 'sunio_product_mobile_top_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_mobile_right_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_mobile_bottom_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_mobile_left_border_width', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );

			$wp_customize->add_control( new sunio_Customizer_Dimensions_Control( $wp_customize, 'sunio_product_border_width', array(
				'label'	   				=> esc_html__( 'Border Width (px)', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'settings'   => array(
		            'desktop_top' 		=> 'sunio_product_top_border_width',
		            'desktop_right' 	=> 'sunio_product_right_border_width',
		            'desktop_bottom' 	=> 'sunio_product_bottom_border_width',
		            'desktop_left' 		=> 'sunio_product_left_border_width',
		            'tablet_top' 		=> 'sunio_product_tablet_top_border_width',
		            'tablet_right' 		=> 'sunio_product_tablet_right_border_width',
		            'tablet_bottom' 	=> 'sunio_product_tablet_bottom_border_width',
		            'tablet_left' 		=> 'sunio_product_tablet_left_border_width',
		            'mobile_top' 		=> 'sunio_product_mobile_top_border_width',
		            'mobile_right' 		=> 'sunio_product_mobile_right_border_width',
		            'mobile_bottom' 	=> 'sunio_product_mobile_bottom_border_width',
		            'mobile_left' 		=> 'sunio_product_mobile_left_border_width',
				),
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 0,
			 ...
			 */
			$wp_customize->add_setting( 'sunio_product_top_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_right_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_bottom_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );
			$wp_customize->add_setting( 'sunio_product_left_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );

			$wp_customize->add_setting( 'sunio_product_tablet_top_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_tablet_right_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_tablet_bottom_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_tablet_left_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );

			$wp_customize->add_setting( 'sunio_product_mobile_top_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_mobile_right_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_mobile_bottom_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );
			$wp_customize->add_setting( 'sunio_product_mobile_left_border_radius', array(
				'transport' 			=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_number_blank',
			) );

			$wp_customize->add_control( new sunio_Customizer_Dimensions_Control( $wp_customize, 'sunio_product_border_radius', array(
				'label'	   				=> esc_html__( 'Border Radius (px)', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'settings'   => array(
		            'desktop_top' 		=> 'sunio_product_top_border_radius',
		            'desktop_right' 	=> 'sunio_product_right_border_radius',
		            'desktop_bottom' 	=> 'sunio_product_bottom_border_radius',
		            'desktop_left' 		=> 'sunio_product_left_border_radius',
		            'tablet_top' 		=> 'sunio_product_tablet_top_border_radius',
		            'tablet_right' 		=> 'sunio_product_tablet_right_border_radius',
		            'tablet_bottom' 	=> 'sunio_product_tablet_bottom_border_radius',
		            'tablet_left' 		=> 'sunio_product_tablet_left_border_radius',
		            'mobile_top' 		=> 'sunio_product_mobile_top_border_radius',
		            'mobile_right' 		=> 'sunio_product_mobile_right_border_radius',
		            'mobile_bottom' 	=> 'sunio_product_mobile_bottom_border_radius',
		            'mobile_left' 		=> 'sunio_product_mobile_left_border_radius',
				),
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 0,
		     ...
		     * Background Color
		     */
	        $wp_customize->add_setting( 'sunio_product_background_color', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_background_color', array(
				'label'					=> esc_html__( 'Background Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_background_color',
				'priority'				=> 10
			) ) );
		     ...
		     * Border Color
		     */
	        $wp_customize->add_setting( 'sunio_product_border_color', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_border_color', array(
				'label'					=> esc_html__( 'Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_border_color',
				'priority'				=> 10
			) ) );
		     ...
		     * Category Color
		     */
	        $wp_customize->add_setting( 'sunio_category_color', array(
				'default'				=> '#999999',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_category_color', array(
				'label'					=> esc_html__( 'Category Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_category_color',
				'priority'				=> 10
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_category_color_hover', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_category_color_hover', array(
				'label'					=> esc_html__( 'Category Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_category_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_title_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_title_color', array(
				'label'					=> esc_html__( 'Title Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_title_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_title_color_hover', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_title_color_hover', array(
				'label'					=> esc_html__( 'Title Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_title_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_price_color', array(
				'default'				=> '#57bf6d',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_price_color', array(
				'label'					=> esc_html__( 'Price Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_price_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_del_price_color', array(
				'default'				=> '#666666',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_del_price_color', array(
				'label'					=> esc_html__( 'Del Price Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_del_price_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_hover_thumbnails_border_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_hover_thumbnails_border_color', array(
				'label'					=> esc_html__( 'Hover: Thumbnails Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_hover_thumbnails_border_color',
				'priority'				=> 10,
				'active_callback' 		=> 'sunio_cac_has_woo_hover_products_style',
			) ) );

			/**
		     * Product Entry Hover Quick View Background
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_hover_quickview_background', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_hover_quickview_background', array(
				'label'					=> esc_html__( 'Hover: Quick View Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_hover_quickview_background',
				'priority'				=> 10,
				'active_callback' 		=> 'sunio_cac_has_woo_hover_products_style',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_hover_quickview_hover_background', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_hover_quickview_hover_background', array(
				'label'					=> esc_html__( 'Hover: Quick View Hover Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_hover_quickview_hover_background',
				'priority'				=> 10,
				'active_callback' 		=> 'sunio_cac_has_woo_hover_products_style',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_hover_quickview_color', array(
				'default'				=> '#444444',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_hover_quickview_color', array(
				'label'					=> esc_html__( 'Hover: Quick View Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_hover_quickview_color',
				'priority'				=> 10,
				'active_callback' 		=> 'sunio_cac_has_woo_hover_products_style',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_hover_quickview_hover_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_hover_quickview_hover_color', array(
				'label'					=> esc_html__( 'Hover: Quick View Hover Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_hover_quickview_hover_color',
				'priority'				=> 10,
				'active_callback' 		=> 'sunio_cac_has_woo_hover_products_style',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_hover_wishlist_background', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_hover_wishlist_background', array(
				'label'					=> esc_html__( 'Hover: Wishlist Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_hover_wishlist_background',
				'priority'				=> 10,
				'active_callback' 		=> 'sunio_cac_has_woo_hover_products_style',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_hover_wishlist_hover_background', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_hover_wishlist_hover_background', array(
				'label'					=> esc_html__( 'Hover: Wishlist Hover Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_hover_wishlist_hover_background',
				'priority'				=> 10,
				'active_callback' 		=> 'sunio_cac_has_woo_hover_products_style',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_hover_wishlist_color', array(
				'default'				=> '#444444',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_hover_wishlist_color', array(
				'label'					=> esc_html__( 'Hover: Wishlist Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_hover_wishlist_color',
				'priority'				=> 10,
				'active_callback' 		=> 'sunio_cac_has_woo_hover_products_style',
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_hover_wishlist_hover_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_hover_wishlist_hover_color', array(
				'label'					=> esc_html__( 'Hover: Wishlist Hover Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_hover_wishlist_hover_color',
				'priority'				=> 10,
				'active_callback' 		=> 'sunio_cac_has_woo_hover_products_style',
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_product_entry_addtocart_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_product_entry_addtocart_heading', array(
				'label'    				=> esc_html__( 'Product Entry: Add To Cart', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_addtocart_bg_color', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_addtocart_bg_color', array(
				'label'					=> esc_html__( 'Add To Cart Background Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_addtocart_bg_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_addtocart_bg_color_hover', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_addtocart_bg_color_hover', array(
				'label'					=> esc_html__( 'Add To Cart Background Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_addtocart_bg_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_addtocart_color', array(
				'default'				=> '#848494',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_addtocart_color', array(
				'label'					=> esc_html__( 'Add To Cart Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_addtocart_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_addtocart_color_hover', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_addtocart_color_hover', array(
				'label'					=> esc_html__( 'Add To Cart Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_addtocart_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_addtocart_border_color', array(
				'default'				=> '#e4e4e4',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_addtocart_border_color', array(
				'label'					=> esc_html__( 'Add To Cart Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_addtocart_border_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_product_entry_addtocart_border_color_hover', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_product_entry_addtocart_border_color_hover', array(
				'label'					=> esc_html__( 'Add To Cart Border Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_product_entry_addtocart_border_color_hover',
				'priority'				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_product_entry_addtocart_border_style', array(
				'default'           	=> 'double',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_select',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sunio_product_entry_addtocart_border_style', array(
				'label'	   				=> esc_html__( 'Add To Cart Border: Style', 'sunio' ),
				'type' 					=> 'select',
				'section'  				=> 'sunio_woocommerce_styling',
				'settings' 				=> 'sunio_product_entry_addtocart_border_style',
				'priority' 				=> 10,
				'choices' 				=> array(
					'none' 			=> esc_html__( 'None', 'sunio' ),
					'solid' 		=> esc_html__( 'Solid', 'sunio' ),
					'double' 		=> esc_html__( 'Double', 'sunio' ),
					'dashed' 		=> esc_html__( 'Dashed', 'sunio' ),
					'dotted' 		=> esc_html__( 'Dotted', 'sunio' ),
				),
			) ) );
		     ...
		     */
			$wp_customize->add_setting( 'sunio_product_entry_addtocart_border_size', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'wp_kses_post',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sunio_product_entry_addtocart_border_size', array(
				'label'	   				=> esc_html__( 'Add To Cart Border: Size', 'sunio' ),
				'description' 			=> esc_html__( 'Add a custom border size. px - em - %.', 'sunio' ),
				'type' 					=> 'text',
				'section'  				=> 'sunio_woocommerce_styling',
				'settings' 				=> 'sunio_product_entry_addtocart_border_size',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
			$wp_customize->add_setting( 'sunio_product_entry_addtocart_border_radius', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'wp_kses_post',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sunio_product_entry_addtocart_border_radius', array(
				'label'	   				=> esc_html__( 'Add To Cart Border: Radius', 'sunio' ),
				'description' 			=> esc_html__( 'Add a custom border radius. px - em - %.', 'sunio' ),
				'type' 					=> 'text',
				'section'  				=> 'sunio_woocommerce_styling',
				'settings' 				=> 'sunio_product_entry_addtocart_border_radius',
				'priority' 				=> 10,
			) ) );
			 ...
			 * Heading Quick View
			 */
			$wp_customize->add_setting( 'sunio_woo_quick_view_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_woo_quick_view_heading', array(
				'label'    				=> esc_html__( 'Quick View', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_quick_view_button_bg', array(
				'default'				=> 'rgba(0,0,0,0.6)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_quick_view_button_bg', array(
				'label'					=> esc_html__( 'Button: Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_quick_view_button_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_quick_view_button_hover_bg', array(
				'default'				=> 'rgba(0,0,0,0.9)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_quick_view_button_hover_bg', array(
				'label'					=> esc_html__( 'Button: Hover Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_quick_view_button_hover_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_quick_view_button_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_quick_view_button_color', array(
				'label'					=> esc_html__( 'Button: Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_quick_view_button_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_quick_view_button_hover_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_quick_view_button_hover_color', array(
				'label'					=> esc_html__( 'Button: Hover Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_quick_view_button_hover_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_quick_view_overlay_bg', array(
				'default'				=> 'rgba(0,0,0,0.15)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_quick_view_overlay_bg', array(
				'label'					=> esc_html__( 'Overlay: Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_quick_view_overlay_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_quick_view_overlay_spinner_outside_color', array(
				'default'				=> 'rgba(0,0,0,0.1)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_quick_view_overlay_spinner_outside_color', array(
				'label'					=> esc_html__( 'Overlay Spinner: Outside Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_quick_view_overlay_spinner_outside_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_quick_view_overlay_spinner_inner_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_quick_view_overlay_spinner_inner_color', array(
				'label'					=> esc_html__( 'Overlay Spinner: Inner Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_quick_view_overlay_spinner_inner_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_quick_view_modal_bg', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_quick_view_modal_bg', array(
				'label'					=> esc_html__( 'Modal: Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_quick_view_modal_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_quick_view_modal_close_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_quick_view_modal_close_color', array(
				'label'					=> esc_html__( 'Modal Close Button: Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_quick_view_modal_close_color',
				'priority'				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_woo_off_canvas_sidebar_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_woo_off_canvas_sidebar_heading', array(
				'label'    				=> esc_html__( 'Off Canvas Sidebar', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_off_canvas_sidebar_bg', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_off_canvas_sidebar_bg', array(
				'label'					=> esc_html__( 'Background Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_off_canvas_sidebar_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_woo_off_canvas_sidebar_widgets_border', array(
				'default'				=> 'rgba(84,84,84,0.15)',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_woo_off_canvas_sidebar_widgets_border', array(
				'label'					=> esc_html__( 'Widgets Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_woo_off_canvas_sidebar_widgets_border',
				'priority'				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_single_product_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_single_product_heading', array(
				'label'    				=> esc_html__( 'Single Product', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_title_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_title_color', array(
				'label'					=> esc_html__( 'Title Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_title_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_price_color', array(
				'default'				=> '#57bf6d',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_price_color', array(
				'label'					=> esc_html__( 'Price Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_price_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_del_price_color', array(
				'default'				=> '#555555',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_del_price_color', array(
				'label'					=> esc_html__( 'Del Price Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_del_price_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_description_color', array(
				'default'				=> '#aaaaaa',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_description_color', array(
				'label'					=> esc_html__( 'Description Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_description_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_quantity_border_color', array(
				'default'				=> '#e4e4e4',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_quantity_border_color', array(
				'label'					=> esc_html__( 'Quantity Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_quantity_border_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_quantity_border_color_focus', array(
				'default'				=> '#bbbbbb',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_quantity_border_color_focus', array(
				'label'					=> esc_html__( 'Quantity Border Color Focus', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_quantity_border_color_focus',
				'priority'				=> 10,
			) ) );
		     ...
		     * Quantity Color
		     */
	        $wp_customize->add_setting( 'sunio_quantity_color', array(
				'default'				=> '#777777',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_quantity_color', array(
				'label'					=> esc_html__( 'Quantity Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_quantity_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_quantity_plus_minus_color', array(
				'default'				=> '#cccccc',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_quantity_plus_minus_color', array(
				'label'					=> esc_html__( 'Quantity Plus/Minus Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_quantity_plus_minus_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_quantity_plus_minus_color_hover', array(
				'default'				=> '#cccccc',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_quantity_plus_minus_color_hover', array(
				'label'					=> esc_html__( 'Quantity Plus/Minus Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_quantity_plus_minus_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_quantity_plus_minus_border_color_hover', array(
				'default'				=> '#e0e0e0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_quantity_plus_minus_border_color_hover', array(
				'label'					=> esc_html__( 'Quantity Plus/Minus Border Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_quantity_plus_minus_border_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_meta_title_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_meta_title_color', array(
				'label'					=> esc_html__( 'Meta Title Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_meta_title_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_meta_link_color', array(
				'default'				=> '#aaaaaa',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_meta_link_color', array(
				'label'					=> esc_html__( 'Meta Link Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_meta_link_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_meta_link_color_hover', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_meta_link_color_hover', array(
				'label'					=> esc_html__( 'Meta Link Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_meta_link_color_hover',
				'priority'				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_single_product_navigation_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_single_product_navigation_heading', array(
				'label'    				=> esc_html__( 'Single Product: Product Navigation', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_single_product_navigation_border_radius', array(
				'transport' 			=> 'postMessage',
				'default'           	=> '30',
				'sanitize_callback' 	=> 'sunio_sanitize_number',
			) );

			$wp_customize->add_control( new sunio_Customizer_Range_Control( $wp_customize, 'sunio_single_product_navigation_border_radius', array(
				'label'	   				=> esc_html__( 'Border Radius (px)', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'settings' 				=> 'sunio_single_product_navigation_border_radius',
				'priority' 				=> 10,
			    'input_attrs' 			=> array(
			        'min'   => 0,
			        'max'   => 30,
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_navigation_bg', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_navigation_bg', array(
				'label'					=> esc_html__( 'Background Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_navigation_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_navigation_hover_bg', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_navigation_hover_bg', array(
				'label'					=> esc_html__( 'Background Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_navigation_hover_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_navigation_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_navigation_color', array(
				'label'					=> esc_html__( 'Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_navigation_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_navigation_hover_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_navigation_hover_color', array(
				'label'					=> esc_html__( 'Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_navigation_hover_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_navigation_border_color', array(
				'default'				=> '#e9e9e9',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_navigation_border_color', array(
				'label'					=> esc_html__( 'Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_navigation_border_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_navigation_hover_border_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_navigation_hover_border_color', array(
				'label'					=> esc_html__( 'Border Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_navigation_hover_border_color',
				'priority'				=> 10,
			) ) );
			 ...
			 * Heading Product Entry Add To Cart
			 */
			$wp_customize->add_setting( 'sunio_single_product_addtocart_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_single_product_addtocart_heading', array(
				'label'    				=> esc_html__( 'Single Product: Add To Cart', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     * Product Entry Add To Cart Background Color
		     */
	        $wp_customize->add_setting( 'sunio_single_product_addtocart_bg_color', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_addtocart_bg_color', array(
				'label'					=> esc_html__( 'Add To Cart Background Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_addtocart_bg_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Product Entry Add To Cart Background Color Hover
		     */
	        $wp_customize->add_setting( 'sunio_single_product_addtocart_bg_color_hover', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_addtocart_bg_color_hover', array(
				'label'					=> esc_html__( 'Add To Cart Background Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_addtocart_bg_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     * Product Entry Add To Cart Color
		     */
	        $wp_customize->add_setting( 'sunio_single_product_addtocart_color', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_addtocart_color', array(
				'label'					=> esc_html__( 'Add To Cart Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_addtocart_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Product Entry Add To Cart Color Hover
		     */
	        $wp_customize->add_setting( 'sunio_single_product_addtocart_color_hover', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_addtocart_color_hover', array(
				'label'					=> esc_html__( 'Add To Cart Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_addtocart_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     * Product Entry Add To Cart Border Color
		     */
	        $wp_customize->add_setting( 'sunio_single_product_addtocart_border_color', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_addtocart_border_color', array(
				'label'					=> esc_html__( 'Add To Cart Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_addtocart_border_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Product Entry Add To Cart Border Color Hover
		     */
	        $wp_customize->add_setting( 'sunio_single_product_addtocart_border_color_hover', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_addtocart_border_color_hover', array(
				'label'					=> esc_html__( 'Add To Cart Border Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_addtocart_border_color_hover',
				'priority'				=> 10,
			) ) );
			 ...
			 * Product Entry Add To Cart Border Style
			 */
			$wp_customize->add_setting( 'sunio_single_product_addtocart_border_style', array(
				'default'				=> 'none',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_select',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sunio_single_product_addtocart_border_style', array(
				'label'	   				=> esc_html__( 'Add To Cart Border: Style', 'sunio' ),
				'type' 					=> 'select',
				'section'  				=> 'sunio_woocommerce_styling',
				'settings' 				=> 'sunio_single_product_addtocart_border_style',
				'priority' 				=> 10,
				'choices' 				=> array(
					'none' 			=> esc_html__( 'None', 'sunio' ),
					'solid' 		=> esc_html__( 'Solid', 'sunio' ),
		     ...
		     * Product Entry Add To Cart Border Size
		     */
			$wp_customize->add_setting( 'sunio_single_product_addtocart_border_size', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'wp_kses_post',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sunio_single_product_addtocart_border_size', array(
				'label'	   				=> esc_html__( 'Add To Cart Border: Size', 'sunio' ),
				'description' 			=> esc_html__( 'Add a custom border size. px - em - %.', 'sunio' ),
				'type' 					=> 'text',
				'section'  				=> 'sunio_woocommerce_styling',
				'settings' 				=> 'sunio_single_product_addtocart_border_size',
				'priority' 				=> 10,
			) ) );
		     ...
		     * Product Entry Add To Cart Border Radius
		     */
			$wp_customize->add_setting( 'sunio_single_product_addtocart_border_radius', array(
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'wp_kses_post',
			) );

			$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'sunio_single_product_addtocart_border_radius', array(
				'label'	   				=> esc_html__( 'Add To Cart Border: Radius', 'sunio' ),
				'description' 			=> esc_html__( 'Add a custom border radius. px - em - %.', 'sunio' ),
				'type' 					=> 'text',
				'section'  				=> 'sunio_woocommerce_styling',
				'settings' 				=> 'sunio_single_product_addtocart_border_radius',
				'priority' 				=> 10,
			) ) );
			 ...
			 */
			$wp_customize->add_setting( 'sunio_single_product_tabs_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_single_product_tabs_heading', array(
				'label'    				=> esc_html__( 'Single Product: Tabs', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_tabs_borders_color', array(
				'default'				=> '#e9e9e9',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_tabs_borders_color', array(
				'label'					=> esc_html__( 'Borders Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_tabs_borders_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_tabs_text_color', array(
				'default'				=> '#999999',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_tabs_text_color', array(
				'label'					=> esc_html__( 'Text Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_tabs_text_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_tabs_text_color_hover', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_tabs_text_color_hover', array(
				'label'					=> esc_html__( 'Text Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_tabs_text_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_tabs_active_text_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_tabs_active_text_color', array(
				'label'					=> esc_html__( 'Active Text Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_tabs_active_text_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_tabs_active_text_borders_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_tabs_active_text_borders_color', array(
				'label'					=> esc_html__( 'Active Text Borders Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_tabs_active_text_borders_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_single_product_tabs_product_description_title_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_tabs_product_description_title_color', array(
				'label'					=> esc_html__( 'Product Description: Title Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_tabs_product_description_title_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Single Product Tabs Product Description Color
		     */
	        $wp_customize->add_setting( 'sunio_single_product_tabs_product_description_color', array(
				'default'				=> '#929292',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_single_product_tabs_product_description_color', array(
				'label'					=> esc_html__( 'Product Description: Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_single_product_tabs_product_description_color',
				'priority'				=> 10,
			) ) );
			 ...
			 * Heading Account
			 */
			$wp_customize->add_setting( 'sunio_account_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_account_heading', array(
				'label'    				=> esc_html__( 'Account', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_login_register_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_login_register_color', array(
				'label'					=> esc_html__( 'Login/Register Links: Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_login_register_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_navigation_borders_color', array(
				'default'				=> '#e9e9e9',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_navigation_borders_color', array(
				'label'					=> esc_html__( 'Navigation: Borders Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_navigation_borders_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_navigation_icons_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_navigation_icons_color', array(
				'label'					=> esc_html__( 'Navigation: Icons Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_navigation_icons_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_navigation_links_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_navigation_links_color', array(
				'label'					=> esc_html__( 'Navigation: Links Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_navigation_links_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_navigation_links_color_hover', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_navigation_links_color_hover', array(
				'label'					=> esc_html__( 'Navigation: Links Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_navigation_links_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_addresses_bg', array(
				'default'				=> '#f6f6f6',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_addresses_bg', array(
				'label'					=> esc_html__( 'Addresses: Box Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_addresses_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_addresses_title_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_addresses_title_color', array(
				'label'					=> esc_html__( 'Addresses: Box Title Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_addresses_title_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_addresses_title_border_color', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_addresses_title_border_color', array(
				'label'					=> esc_html__( 'Addresses: Box Title Border Bottom Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_addresses_title_border_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_addresses_content_color', array(
				'default'				=> '#898989',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_addresses_content_color', array(
				'label'					=> esc_html__( 'Addresses: Box Content Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_addresses_content_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_addresses_button_bg', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_addresses_button_bg', array(
				'label'					=> esc_html__( 'Addresses: Box Button Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_addresses_button_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_addresses_button_bg_hover', array(
				'default'				=> '#f8f8f8',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_addresses_button_bg_hover', array(
				'label'					=> esc_html__( 'Addresses: Box Button Background: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_addresses_button_bg_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_addresses_button_color', array(
				'default'				=> '#898989',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_addresses_button_color', array(
				'label'					=> esc_html__( 'Addresses: Box Button color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_addresses_button_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_account_addresses_button_color_hover', array(
				'default'				=> '#555555',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_account_addresses_button_color_hover', array(
				'label'					=> esc_html__( 'Addresses: Box Button color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_account_addresses_button_color_hover',
				'priority'				=> 10,
			) ) );
			 ...
			 * Heading Cart
			 */
			$wp_customize->add_setting( 'sunio_cart_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_cart_heading', array(
				'label'    				=> esc_html__( 'Cart', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     * Borders Color
		     */
	        $wp_customize->add_setting( 'sunio_cart_borders_color', array(
				'default'				=> '#e9e9e9',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_cart_borders_color', array(
				'label'					=> esc_html__( 'Borders Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_cart_borders_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Head Background
		     */
	        $wp_customize->add_setting( 'sunio_cart_head_bg', array(
				'default'				=> '#f7f7f7',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_cart_head_bg', array(
				'label'					=> esc_html__( 'Head Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_cart_head_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     * Head Titles Color
		     */
	        $wp_customize->add_setting( 'sunio_cart_head_titles_color', array(
				'default'				=> '#444444',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_cart_head_titles_color', array(
				'label'					=> esc_html__( 'Head Titles Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_cart_head_titles_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_cart_totals_table_titles_color', array(
				'default'				=> '#444444',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_cart_totals_table_titles_color', array(
				'label'					=> esc_html__( 'Cart Totals Table: Titles Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_cart_totals_table_titles_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Remove Button Color
		     */
	        $wp_customize->add_setting( 'sunio_cart_remove_button_color', array(
				'default'				=> '#bbbbbb',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );
			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_cart_remove_button_color', array(
				'label'					=> esc_html__( 'Remove Button Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_cart_remove_button_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_cart_remove_button_color_hover', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_cart_remove_button_color_hover', array(
				'label'					=> esc_html__( 'Remove Button Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_cart_remove_button_color_hover',
				'priority'				=> 10,
			) ) );
			 ...
			 * Heading Checkout
			 */
			$wp_customize->add_setting( 'sunio_checkout_heading', array(
				'sanitize_callback' 	=> 'wp_kses',
			) );

			$wp_customize->add_control( new sunio_Customizer_Heading_Control( $wp_customize, 'sunio_checkout_heading', array(
				'label'    				=> esc_html__( 'Checkout', 'sunio' ),
				'section'  				=> 'sunio_woocommerce_styling',
				'priority' 				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_checkout_notices_borders_color', array(
				'default'				=> '#e9e9e9',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_notices_borders_color', array(
				'label'					=> esc_html__( 'Notices: Borders Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_notices_borders_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Notices Icon Color
		     */
	        $wp_customize->add_setting( 'sunio_checkout_notices_icon_color', array(
				'default'				=> '#dddddd',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_notices_icon_color', array(
				'label'					=> esc_html__( 'Notices: Icon Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_notices_icon_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Notices Color
		     */
	        $wp_customize->add_setting( 'sunio_checkout_notices_color', array(
				'default'				=> '#777777',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_notices_color', array(
				'label'					=> esc_html__( 'Notices: Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_notices_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Notices Link Color
		     */
	        $wp_customize->add_setting( 'sunio_checkout_notices_link_color', array(
				'default'				=> '#13aff0',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_notices_link_color', array(
				'label'					=> esc_html__( 'Notices: Link Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_notices_link_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_checkout_notices_link_color_hover', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_notices_link_color_hover', array(
				'label'					=> esc_html__( 'Notices: Link Color: Hover', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_notices_link_color_hover',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_checkout_notices_form_border_color', array(
				'default'				=> '#e9e9e9',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_notices_form_border_color', array(
				'label'					=> esc_html__( 'Notices Form: Border Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_notices_form_border_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Titles Color
		     */
	        $wp_customize->add_setting( 'sunio_checkout_titles_color', array(
				'default'				=> '#333333',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_titles_color', array(
				'label'					=> esc_html__( 'Titles Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_titles_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_checkout_titles_border_bottom_color', array(
				'default'				=> '#e9e9e9',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_titles_border_bottom_color', array(
				'label'					=> esc_html__( 'Titles Border Bottom Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_titles_border_bottom_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_checkout_table_main_bg', array(
				'default'				=> '#f7f7f7',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_table_main_bg', array(
				'label'					=> esc_html__( 'Table Main Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_table_main_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     * Table Titles Color
		     */
	        $wp_customize->add_setting( 'sunio_checkout_table_titles_color', array(
				'default'				=> '#444444',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_table_titles_color', array(
				'label'					=> esc_html__( 'Table Titles Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_table_titles_color',
				'priority'				=> 10,
			) ) );
		     ...
		     * Table Borders Color
		     */
	        $wp_customize->add_setting( 'sunio_checkout_table_borders_color', array(
				'default'				=> '#e9e9e9',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_table_borders_color', array(
				'label'					=> esc_html__( 'Table Borders Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_table_borders_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_checkout_payment_methods_bg', array(
				'default'				=> '#f8f8f8',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_payment_methods_bg', array(
				'label'					=> esc_html__( 'Payment Methods Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_payment_methods_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_checkout_payment_methods_borders_color', array(
				'default'				=> '#e9e9e9',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_payment_methods_borders_color', array(
				'label'					=> esc_html__( 'Payment Methods Borders Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_payment_methods_borders_color',
				'priority'				=> 10,
			) ) );
		     ...
		     */
	        $wp_customize->add_setting( 'sunio_checkout_payment_box_bg', array(
				'default'				=> '#ffffff',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_payment_box_bg', array(
				'label'					=> esc_html__( 'Payment Box Background', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_payment_box_bg',
				'priority'				=> 10,
			) ) );
		     ...
		     * Payment Box Color
		     */
	        $wp_customize->add_setting( 'sunio_checkout_payment_box_color', array(
				'default'				=> '#515151',
				'transport'				=> 'postMessage',
				'sanitize_callback' 	=> 'sunio_sanitize_color',
			) );

			$wp_customize->add_control( new sunio_Customizer_Color_Control( $wp_customize, 'sunio_checkout_payment_box_color', array(
				'label'					=> esc_html__( 'Payment Box Color', 'sunio' ),
				'section'				=> 'sunio_woocommerce_styling',
				'settings'				=> 'sunio_checkout_payment_box_color',
				'priority'				=> 10,
			) ) );
		...
		public static function head_css( $output ) {
			...
			$cart_dropdown_width 								= get_theme_mod( 'sunio_woo_cart_dropdown_width', '350' );
			$woo_menu_bag_icon_color 							= get_theme_mod( 'sunio_woo_menu_bag_icon_color', '#333333' );
			$woo_menu_bag_icon_hover_color 						= get_theme_mod( 'sunio_woo_menu_bag_icon_hover_color', '#13aff0' );
			$woo_menu_bag_icon_count_color 						= get_theme_mod( 'sunio_woo_menu_bag_icon_count_color', '#333333' );
			$woo_menu_bag_icon_hover_count_color 				= get_theme_mod( 'sunio_woo_menu_bag_icon_hover_count_color', '#ffffff' );
			$cart_dropdown_bg 									= get_theme_mod( 'sunio_woo_cart_dropdown_bg', '#ffffff' );
			$cart_dropdown_borders 								= get_theme_mod( 'sunio_woo_cart_dropdown_borders', '#e6e6e6' );
			$cart_dropdown_link_color 							= get_theme_mod( 'sunio_woo_cart_dropdown_link_color', '#333333' );
			$cart_dropdown_link_color_hover 					= get_theme_mod( 'sunio_woo_cart_dropdown_link_color_hover', '#13aff0' );
			$cart_dropdown_remove_link_color					= get_theme_mod( 'sunio_woo_cart_dropdown_remove_link_color', '#b3b3b3' );
			$cart_dropdown_remove_link_color_hover				= get_theme_mod( 'sunio_woo_cart_dropdown_remove_link_color_hover', '#13aff0' );
			$cart_dropdown_quantity_color						= get_theme_mod( 'sunio_woo_cart_dropdown_quantity_color', '#b2b2b2' );
			$cart_dropdown_price_color							= get_theme_mod( 'sunio_woo_cart_dropdown_price_color', '#57bf6d' );
			$cart_dropdown_subtotal_bg							= get_theme_mod( 'sunio_woo_cart_dropdown_subtotal_bg', '#fafafa' );
			$cart_dropdown_subtotal_color						= get_theme_mod( 'sunio_woo_cart_dropdown_subtotal_color', '#797979' );
			$cart_dropdown_total_price_color					= get_theme_mod( 'sunio_woo_cart_dropdown_total_price_color', '#57bf6d' );
			$cart_dropdown_cart_button_bg						= get_theme_mod( 'sunio_woo_cart_dropdown_cart_button_bg' );
			$cart_dropdown_cart_button_hover_bg					= get_theme_mod( 'sunio_woo_cart_dropdown_cart_button_hover_bg' );
			$cart_dropdown_cart_button_color					= get_theme_mod( 'sunio_woo_cart_dropdown_cart_button_color' );
			$cart_dropdown_cart_button_hover_color				= get_theme_mod( 'sunio_woo_cart_dropdown_cart_button_hover_color' );
			$cart_dropdown_cart_button_border_color				= get_theme_mod( 'sunio_woo_cart_dropdown_cart_button_border_color' );
			$cart_dropdown_cart_button_hover_border_color		= get_theme_mod( 'sunio_woo_cart_dropdown_cart_button_hover_border_color' );
			$cart_dropdown_checkout_button_bg					= get_theme_mod( 'sunio_woo_cart_dropdown_checkout_button_bg' );
			$cart_dropdown_checkout_button_hover_bg				= get_theme_mod( 'sunio_woo_cart_dropdown_checkout_button_hover_bg' );
			$cart_dropdown_checkout_button_color				= get_theme_mod( 'sunio_woo_cart_dropdown_checkout_button_color' );
			$cart_dropdown_checkout_button_hover_color			= get_theme_mod( 'sunio_woo_cart_dropdown_checkout_button_hover_color' );
			$woo_mobile_cart_sidebar_bg							= get_theme_mod( 'sunio_woo_mobile_cart_sidebar_bg', '#ffffff' );
			...
			$onsale_bg 											= get_theme_mod( 'sunio_onsale_bg', '#3FC387' );
			$onsale_color 										= get_theme_mod( 'sunio_onsale_color', '#ffffff' );
			$outofstock_bg 										= get_theme_mod( 'sunio_outofstock_bg', '#000000' );
			$outofstock_color 									= get_theme_mod( 'sunio_outofstock_color', '#ffffff' );
			$stars_color_before 								= get_theme_mod( 'sunio_stars_color_before', '#dfdbdf' );
			$stars_color 										= get_theme_mod( 'sunio_stars_color', '#f9ca63' );
			...
			$product_top_padding 								= get_theme_mod( 'sunio_product_top_padding' );
			$product_right_padding 								= get_theme_mod( 'sunio_product_right_padding' );
			$product_bottom_padding 							= get_theme_mod( 'sunio_product_bottom_padding' );
			$product_left_padding 								= get_theme_mod( 'sunio_product_left_padding' );
			$tablet_product_top_padding 						= get_theme_mod( 'sunio_product_tablet_top_padding' );
			$tablet_product_right_padding 						= get_theme_mod( 'sunio_product_tablet_right_padding' );
			$tablet_product_bottom_padding 						= get_theme_mod( 'sunio_product_tablet_bottom_padding' );
			$tablet_product_left_padding 						= get_theme_mod( 'sunio_product_tablet_left_padding' );
			$mobile_product_top_padding 						= get_theme_mod( 'sunio_product_mobile_top_padding' );
			$mobile_product_right_padding 						= get_theme_mod( 'sunio_product_mobile_right_padding' );
			$mobile_product_bottom_padding 						= get_theme_mod( 'sunio_product_mobile_bottom_padding' );
			$mobile_product_left_padding 						= get_theme_mod( 'sunio_product_mobile_left_padding' );
			$product_image_top_margin 							= get_theme_mod( 'sunio_product_image_top_margin' );
			$product_image_right_margin 						= get_theme_mod( 'sunio_product_image_right_margin' );
			$product_image_bottom_margin 						= get_theme_mod( 'sunio_product_image_bottom_margin' );
			$product_image_left_margin 							= get_theme_mod( 'sunio_product_image_left_margin' );
			$tablet_product_image_top_margin 					= get_theme_mod( 'sunio_product_image_tablet_top_margin' );
			$tablet_product_image_right_margin 					= get_theme_mod( 'sunio_product_image_tablet_right_margin' );
			$tablet_product_image_bottom_margin 				= get_theme_mod( 'sunio_product_image_tablet_bottom_margin' );
			$tablet_product_image_left_margin 					= get_theme_mod( 'sunio_product_image_tablet_left_margin' );
			$mobile_product_image_top_margin 					= get_theme_mod( 'sunio_product_image_mobile_top_margin' );
			$mobile_product_image_right_margin 					= get_theme_mod( 'sunio_product_image_mobile_right_margin' );
			$mobile_product_image_bottom_margin 				= get_theme_mod( 'sunio_product_image_mobile_bottom_margin' );
			$mobile_product_image_left_margin 					= get_theme_mod( 'sunio_product_image_mobile_left_margin' );
			$product_top_border_width 							= get_theme_mod( 'sunio_product_top_border_width' );
			$product_right_border_width 						= get_theme_mod( 'sunio_product_right_border_width' );
			$product_bottom_border_width 						= get_theme_mod( 'sunio_product_bottom_border_width' );
			$product_left_border_width 							= get_theme_mod( 'sunio_product_left_border_width' );
			$tablet_product_top_border_width 					= get_theme_mod( 'sunio_product_tablet_top_border_width' );
			$tablet_product_right_border_width 					= get_theme_mod( 'sunio_product_tablet_right_border_width' );
			$tablet_product_bottom_border_width 				= get_theme_mod( 'sunio_product_tablet_bottom_border_width' );
			$tablet_product_left_border_width 					= get_theme_mod( 'sunio_product_tablet_left_border_width' );
			$mobile_product_top_border_width 					= get_theme_mod( 'sunio_product_mobile_top_border_width' );
			$mobile_product_right_border_width 					= get_theme_mod( 'sunio_product_mobile_right_border_width' );
			$mobile_product_bottom_border_width 				= get_theme_mod( 'sunio_product_mobile_bottom_border_width' );
			$mobile_product_left_border_width 					= get_theme_mod( 'sunio_product_mobile_left_border_width' );
			$product_top_border_radius 							= get_theme_mod( 'sunio_product_top_border_radius' );
			$product_right_border_radius 						= get_theme_mod( 'sunio_product_right_border_radius' );
			$product_bottom_border_radius 						= get_theme_mod( 'sunio_product_bottom_border_radius' );
			$product_left_border_radius 						= get_theme_mod( 'sunio_product_left_border_radius' );
			$tablet_product_top_border_radius 					= get_theme_mod( 'sunio_product_tablet_top_border_radius' );
			$tablet_product_right_border_radius 				= get_theme_mod( 'sunio_product_tablet_right_border_radius' );
			$tablet_product_bottom_border_radius 				= get_theme_mod( 'sunio_product_tablet_bottom_border_radius' );
			$tablet_product_left_border_radius 					= get_theme_mod( 'sunio_product_tablet_left_border_radius' );
			$mobile_product_top_border_radius 					= get_theme_mod( 'sunio_product_mobile_top_border_radius' );
			$mobile_product_right_border_radius 				= get_theme_mod( 'sunio_product_mobile_right_border_radius' );
			$mobile_product_bottom_border_radius 				= get_theme_mod( 'sunio_product_mobile_bottom_border_radius' );
			$mobile_product_left_border_radius 					= get_theme_mod( 'sunio_product_mobile_left_border_radius' );
			$product_background_color 							= get_theme_mod( 'sunio_product_background_color' );
			$product_border_color 								= get_theme_mod( 'sunio_product_border_color' );
			...
			$single_product_navigation_bg 						= get_theme_mod( 'sunio_single_product_navigation_bg' );
			...
			$single_product_addtocart_bg_color 					= get_theme_mod( 'sunio_single_product_addtocart_bg_color' );
			$single_product_addtocart_bg_color_hover 			= get_theme_mod( 'sunio_single_product_addtocart_bg_color_hover' );
			$single_product_addtocart_color 					= get_theme_mod( 'sunio_single_product_addtocart_color' );
			$single_product_addtocart_color_hover 				= get_theme_mod( 'sunio_single_product_addtocart_color_hover' );
			$single_product_addtocart_border_color 				= get_theme_mod( 'sunio_single_product_addtocart_border_color' );
			$single_product_addtocart_border_color_hover 		= get_theme_mod( 'sunio_single_product_addtocart_border_color_hover' );
			$single_product_addtocart_border_style 				= get_theme_mod( 'sunio_single_product_addtocart_border_style' );
			$single_product_addtocart_border_size 				= get_theme_mod( 'sunio_single_product_addtocart_border_size' );
			$single_product_addtocart_border_radius 			= get_theme_mod( 'sunio_single_product_addtocart_border_radius' );
