( function( $ ) {
	var WidgetaztNewsletterHandler = function( $scope, $ ) {

		var $form = $scope;

		function aztisValidEmailAddress( emailAddress ) {
	    ...
	    $form.find( '#mc-embedded-subscribe-form' ).on( 'submit', function( e ) {
			...
			var $ajaxurl 	= $form.find( '.azt-newsletter-form' ).data( 'ajaxurl' ),
				element 	= $( this ),
	        ...
	        } else if ( ! aztisValidEmailAddress( email ) ) {
	            valid = false;
	...
	$( window ).on( 'elementor/frontend/init', function() {
		elementorFrontend.hooks.addAction( 'frontend/element_ready/azt-newsletter.default', WidgetaztNewsletterHandler );
	} );
} )( jQuery );