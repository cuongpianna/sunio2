	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'raw' 		=> __( 'This widget is the main menu for your custom header style.', 'sunio' ),
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Links Background', 'sunio' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Active Links Color', 'sunio' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Active Links Background', 'sunio' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Top Border Color', 'sunio' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
		...
		$this->add_control(
			...
			[
				'label' 		=> __( 'Links Border Color', 'sunio' ),
				'type' 			=> Controls_Manager::COLOR,
				'selectors' 	=> [
