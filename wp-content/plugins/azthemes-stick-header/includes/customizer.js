...
( function( $ ) {
	...
	api( 'osh_fixed_header_height', function( value ) {
		value.bind( function( to ) {
			...
			if ( to ) {
				var style = '<style class="customizer-osh_fixed_header_height">.is-sticky #site-header.sunio-fixed-sticky-header #site-logo #site-logo-inner,.is-sticky #site-header.sunio-fixed-sticky-header #sunio-social-menu .social-menu-inner { height: ' + to + 'px; }.is-sticky #site-header.sunio-fixed-sticky-header #site-navigation-wrap .dropdown-menu > li > a,.is-sticky #site-header.sunio-fixed-sticky-header #sunio-mobile-menu-icon a{line-height: ' + to + 'px;}</style>';
				if ( $child.length ) {
					$child.replaceWith( style );
				} else {
					$( 'head' ).append( style );
	...
	api( 'osh_sticky_header_opacity', function( value ) {
		value.bind( function( to ) {
			$( '.is-sticky #site-header,.sunio-sticky-top-bar-holder.is-sticky #top-bar-wrap,.is-sticky .header-top' ).css( 'opacity', to );
		} );
	} );
	...
	api( 'osh_links_color', function( value ) {
		value.bind( function( to ) {
			...
			if ( to ) {
				var style = '<style class="customizer-osh_links_color">.is-sticky #site-navigation-wrap .dropdown-menu > li > a,.is-sticky #sunio-mobile-menu-icon a,.is-sticky #searchform-header-replace-close{color: ' + to + ';}</style>';
				if ( $child.length ) {
					$child.replaceWith( style );
				} else {
					$( 'head' ).append( style );
	...
	api( 'osh_links_hover_color', function( value ) {
		value.bind( function( to ) {
			...
			if ( to ) {
				var style = '<style class="customizer-osh_links_hover_color">.is-sticky #site-navigation-wrap .dropdown-menu > li > a:hover,.is-sticky #sunio-mobile-menu-icon a:hover,.is-sticky #searchform-header-replace-close:hover{color: ' + to + ';}</style>';
				if ( $child.length ) {
					$child.replaceWith( style );
				} else {
					$( 'head' ).append( style );
	...
	api( 'osh_menu_social_links_color', function( value ) {
		value.bind( function( to ) {
			...
			if ( to ) {
				var style = '<style class="customizer-osh_menu_social_links_color">.is-sticky #sunio-social-menu ul li a,.is-sticky #site-header.full_screen-header #sunio-social-menu.simple-social ul li a{color: ' + to + ';}</style>';
				if ( $child.length ) {
					$child.replaceWith( style );
				} else {
					$( 'head' ).append( style );
	...
	api( 'osh_menu_social_hover_links_color', function( value ) {
		value.bind( function( to ) {
			...
			if ( to ) {
				var style = '<style class="customizer-osh_menu_social_hover_links_color">.is-sticky #sunio-social-menu ul li a:hover,.is-sticky #site-header.full_screen-header #sunio-social-menu.simple-social ul li a:hover{color: ' + to + ';}</style>';
				if ( $child.length ) {
					$child.replaceWith( style );
				} else {
					$( 'head' ).append( style );
