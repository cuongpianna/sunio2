...
abstract class AZT_Form_Field {
	...
	protected static $types = array(
		'text'            => 'AZT_Form_Field_Text',
		'number'          => 'AZT_Form_Field_Text',
		'url'             => 'AZT_Form_Field_Text',
		'color'           => 'AZT_Form_Field_Text',
		'date'            => 'AZT_Form_Field_Text',
		'hidden'          => 'AZT_Form_Field_Text',
		'checkbox'        => 'AZT_Form_Field_Checkbox',
		'radio'           => 'AZT_Form_Field_Radio',
		'textarea'        => 'AZT_Form_Field_Textarea',
		'select'          => 'AZT_Form_Field_Select',
		'select_multiple' => 'AZT_Form_Field_Select_Multiple',
		'select_pages'    => 'AZT_Form_Field_Select_Pages',
		'special'         => 'AZT_Form_Field_Special',
	);
	...
	*/
	...
	final public static function create( array $field, $args = array() ) {
		...
		if ( ! isset( self::$types[ $field['type'] ] )
			...
			trigger_error(
				sprintf(
					esc_html__( '%1$s: Type %2$s is not supported, reverting to text.', 'sunio-extra' ),
					__CLASS__,
					esc_html( $field['type'] )
				),
				E_USER_WARNING
 ...
 * Field: text
 */
class AZT_Form_Field_Text extends AZT_Form_Field {
 ...
 * Field: Textarea
 */
class AZT_Form_Field_Textarea extends AZT_Form_Field {
 ...
 * Field: Checkbox
 */
class AZT_Form_Field_Checkbox extends AZT_Form_Field {
 ...
 * Field: Radio
 */
class AZT_Form_Field_Radio extends AZT_Form_Field_Checkbox {
 ...
 * Field: Select
 */
class AZT_Form_Field_Select extends AZT_Form_Field {
 ...
 */
class AZT_Form_Field_Select_Multiple extends AZT_Form_Field_Select {
 ...
 * Field: Select Pages
 */
class AZT_Form_Field_Select_Pages extends AZT_Form_Field_Select {
 ...
 */
class AZT_Form_Field_Special extends AZT_Form_Field {
	public function render() {
