...
final class AZT_Icon_Picker_Loader {

	/**
	 * AZT_Icon_Picker_Loader singleton
	 *
	 */
	...
	public function load() {
		if ( ! is_admin() ) {
			_doing_it_wrong(
				...
				esc_html( AZT_Icon_Selector::VERSION )
			);
	...
	public function _media_view_strings( $strings ) {
		$strings['iconPicker'] = array(
			'frameTitle' => __( 'Icon Picker', 'sunio-extra' ),
			'allFilter'  => __( 'All', 'sunio-extra' ),
			'selectIcon' => __( 'Select Icon', 'sunio-extra' ),
		);
