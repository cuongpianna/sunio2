 ...
 * 
 */
final class AZT_Menu_Icons_Front_End {
	...
	public static function init() {
		$active_types = AZT_Menu_Icons_Settings::get( 'global', 'icon_types' );

		if ( empty( $active_types ) ) {
			return;
		}

		foreach ( AZT_Menu_Icons::get( 'types' ) as $type ) {
	...
	public static function _add_icon( $title, $id ) {
		$meta = AZT_Menu_Icons_Meta::get( $id );
