 ...
 * Nav menu admin
 */
final class AZT_Menu_Icons_Picker {
	...
	public static function _load_nav_menus() {
		AZT_Icon_Selector::instance()->load();
	...
	protected static function _get_menu_item_fields( $meta ) {
		$fields = array_merge(
			...
			AZT_Menu_Icons_Settings::get_settings_fields( $meta )
		);
	...
	public static function _fields( $id, $item, $depth, $args ) {
		...
		$menu_settings = AZT_Menu_Icons_Settings::get_menu_settings( AZT_Menu_Icons_Settings::get_current_menu_id() );
		$meta          = AZT_Menu_Icons_Meta::get( $item->ID, $menu_settings );
		...
		?>
			<div class="field-icon description-wide oe-icons-wrap" data-id="<?php echo json_encode( $item->ID ); ?>">
				...
				<p class="description submitbox">
					<label><?php esc_html_e( 'Icon:', 'sunio-extra' ) ?></label>
					<?php printf( '<a class="_select">%s</a>', esc_html__( 'Select', 'sunio-extra' ) ); ?>
					<?php printf( '<a class="_remove submitdelete hidden">%s</a>', esc_html__( 'Remove', 'sunio-extra' ) ); ?>
				</p>
	...
	public static function _columns( $columns ) {
		$columns['icon'] = __( 'Icon', 'sunio-extra' );
	...
	public static function _save( $menu_id, $menu_item_db_id, $menu_item_args ) {
		...
		AZT_Menu_Icons_Meta::update( $menu_item_db_id, $value );
	}
