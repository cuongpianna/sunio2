 ...
 */
final class AZT_Menu_Icons_Settings {
	...
	public static function init() {
		...
		foreach ( self::$settings as $key => &$value ) {
			if ( 'global' === $key ) {
				...
				$value['icon_types'] = array_values( array_intersect(
					array_keys( AZT_Menu_Icons::get( 'types' ) ),
		...
		if ( ! empty( self::$settings['global']['icon_types'] ) ) {
			require_once AZT_Menu_Icons::get( 'dir' ) . 'includes/picker.php';
			AZT_Menu_Icons_Picker::init();
	...
	public static function _admin_notices() {
		$messages = array(
			'updated' => __( '<strong>Menu Icons Settings</strong> have been successfully updated.', 'sunio-extra' ),
			'reset'   => __( '<strong>Menu Icons Settings</strong> have been successfully reset.', 'sunio-extra' ),
		);
	...
	private static function _add_settings_meta_box() {
		add_meta_box(
			'oe-icons-settings',
			__( 'Menu Icons Settings', 'sunio-extra' ),
	...
	public static function get_settings_fields( array $values = array() ) {
		$fields = array(
			'hide_label' => array(
				'id'      => 'hide_label',
				'type'    => 'select',
				'label'   => __( 'Hide Text', 'sunio-extra' ),
				'default' => '',
				'choices' => array(
					array(
						'value' => '',
						'label' => __( 'No', 'sunio-extra' ),
					),
					array(
						'value' => '1',
						'label' => __( 'Yes', 'sunio-extra' ),
					),
				),
			),
			'position' => array(
				'id'      => 'position',
				'type'    => 'select',
				'label'   => __( 'Position', 'sunio-extra' ),
				'default' => 'before',
				'choices' => array(
					array(
						'value' => 'before',
						'label' => __( 'Before', 'sunio-extra' ),
					),
					array(
						'value' => 'after',
						'label' => __( 'After', 'sunio-extra' ),
					),
					array(
						'value' => 'below',
						'label' => __( 'Below', 'sunio-extra' ),
					),
				),
			),
			'vertical_align' => array(
				'id'      => 'vertical_align',
				'type'    => 'select',
				'label'   => __( 'Vertical Align', 'sunio-extra' ),
				'default' => 'middle',
				'choices' => array(
					array(
						'value' => 'super',
						'label' => __( 'Super', 'sunio-extra' ),
					),
					array(
						'value' => 'top',
						'label' => __( 'Top', 'sunio-extra' ),
					),
					array(
						'value' => 'text-top',
						'label' => __( 'Text Top', 'sunio-extra' ),
					),
					array(
						'value' => 'middle',
						'label' => __( 'Middle', 'sunio-extra' ),
					),
					array(
						'value' => 'baseline',
						'label' => __( 'Baseline', 'sunio-extra' ),
					),
					array(
						'value' => 'text-bottom',
						'label' => __( 'Text Bottom', 'sunio-extra' ),
					),
					array(
						'value' => 'bottom',
						'label' => __( 'Bottom', 'sunio-extra' ),
					),
					array(
						'value' => 'sub',
						'label' => __( 'Sub', 'sunio-extra' ),
					),
				),
			),
			'font_size' => array(
				'id'          => 'font_size',
				'type'        => 'number',
				'label'       => __( 'Font Size', 'sunio-extra' ),
				'default'     => '1.2',
				'description' => 'em',
				'attributes'  => array(
					'min'  => '0.1',
			...
			'svg_width' => array(
				'id'          => 'svg_width',
				'type'        => 'number',
				'label'       => __( 'SVG Width', 'sunio-extra' ),
				'default'     => '1',
				'description' => 'em',
				'attributes'  => array(
					'min'  => '.5',
			...
			'image_size' => array(
				'id'      => 'image_size',
				'type'    => 'select',
				'label'   => __( 'Image Size', 'sunio-extra' ),
				'default' => 'thumbnail',
	...
	public static function get_fields() {
		$menu_id    = self::get_current_menu_id();
		$icon_types = wp_list_pluck( AZT_Menu_Icons::get( 'types' ), 'name' );
		...
		$sections = array(
			'global' => array(
				'id'          => 'global',
				'title'       => __( 'Global', 'sunio-extra' ),
				'description' => __( 'Global settings', 'sunio-extra' ),
				'fields'      => array(
					array(
						'id'      => 'icon_types',
						'type'    => 'checkbox',
						'label'   => __( 'Icon Types', 'sunio-extra' ),
						'choices' => $icon_types,
		...
		if ( ! empty( $menu_id ) ) {
			...
			$sections['menu'] = array(
				'id'          => $menu_key,
				'title'       => __( 'Current Menu', 'sunio-extra' ),
				'description' => sprintf(
					__( '"%s" menu settings', 'sunio-extra' ),
	...
	private static function _get_fields() {
		if ( ! class_exists( 'AZT_Form_Field' ) ) {
			require_once AZT_Menu_Icons::get( 'dir' ) . 'includes/library/form-fields.php';
		}
		...
		foreach ( $sections as &$section ) {
			...
			foreach ( $section['fields'] as &$field ) {
				$field = AZT_Form_Field::create( $field, $_args );
			}
				...
				<span class="list-controls">
					<?php
						printf(
							...
							esc_attr__( 'Discard all changes and reset to default state', 'sunio-extra' ),
							esc_html__( 'Reset', 'sunio-extra' )
						);
					?>
				</span>
	...
	public static function _enqueue_assets() {
		...
		$js_data = apply_filters(
			...
			array(
				'text'           => array(
					'title'        => __( 'Select Icon', 'sunio-extra' ),
					'select'       => __( 'Select', 'sunio-extra' ),
					'remove'       => __( 'Remove', 'sunio-extra' ),
					'change'       => __( 'Change', 'sunio-extra' ),
					'all'          => __( 'All', 'sunio-extra' ),
					'preview'      => __( 'Preview', 'sunio-extra' ),
				),
