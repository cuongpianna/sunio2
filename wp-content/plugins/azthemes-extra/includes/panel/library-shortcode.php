...
if ( ! class_exists( 'sunio_Library_Shortcode' ) ) {

	class sunio_Library_Shortcode {

		/**
		 * Start things up
		 */
		public function __construct() {
			add_shortcode( 'sunio_library', array( $this, 'library_shortcode' ) );
		}
