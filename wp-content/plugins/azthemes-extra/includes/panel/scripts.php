...
// Start Class
class sunio_Extra_Scripts_Panel {
	...
	private static function get_scripts() {
		...
		$scripts = array(
			'oe_customSelect_script'        => array(
				'label' => esc_html__( 'Custom Select', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script uses the native select box and add overlays a stylable <span> element in order to acheive the desired look.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_dropDownSearch_script'      => array(
				'label' => esc_html__( 'Drop Down Search', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is for the drop down search style in your navigation.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_headerReplaceSearch_script' => array(
				'label' => esc_html__( 'Header Replace Search', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is for the header replace search style in your navigation.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_overlaySearch_script'       => array(
				'label' => esc_html__( 'Overlay Search', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is for the overlay search style in your navigation.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_fitVids_script'             => array(
				'label' => esc_html__( 'FitVids', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is to achieve fluid width videos in your responsive web design, your videos looks good on all devices.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_fixedFooter_script'         => array(
				'label' => esc_html__( 'Fixed Footer', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script adds a height to your content to keep your footer at the bottom of your page, the Fixed Footer option need to be activated in the customizer&rsquo;s Footer Widgets section.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_parallax_footer_script'     => array(
				'label' => esc_html__( 'Parallax Footer', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is used for the parallax footer effect.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_fullScreenMenu_script'      => array(
				'label' => esc_html__( 'Full Screen Menu', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is to open your menu in overlay for the full screen header style, you can disable this function if you do not use this header style.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_headerSearchForm_script'    => array(
				'label' => esc_html__( 'Header Search Form', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is to add a class to the search form to make the label disappear when text is inserted, used on some header style like medium or full screen and the full screen mobile menu style.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_infiniteScroll_script'      => array(
				'label' => esc_html__( 'Infinite Scroll', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script create an infinite scrolling effect, used for the blog archives page if Infinite Scroll is selected as pagination style.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_isotope_script'             => array(
				'label' => esc_html__( 'Isotope', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is to filter & sort layouts, used for the masonry grid style of your blog and will be used in some extensions.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_lightbox_script'            => array(
				'label' => esc_html__( 'Lightbox', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script enables you to overlay your images on the current page, used for the gallerie, single product and content images.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_matchHeight_script'         => array(
				'label' => esc_html__( 'Match Height', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is a responsive equal heights script makes the height of all selected elements exactly equal, used for the grid blog style.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_megaMenu_script'            => array(
				'label' => esc_html__( 'Mega Menu', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is to create the mega menus, so if you don&rsquo;t use mega menus at all on your website, you can disable this script.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_navNoClick_script'          => array(
				'label' => esc_html__( 'Nav No Click', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is to prevent clicking on your links, used for the "Disable link" field of your menu items.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_scrollEffect_script'        => array(
				'label' => esc_html__( 'Scroll Effect', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script create an animation to your anchor links, mainly used for a one page site but also for some links like the comment link on your single posts.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_scrollTop_script'           => array(
				'label' => esc_html__( 'Scroll Top', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is to displays the scroll up button and brings you back to the top of your page when you click on it.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_sidr_script'                => array(
				'label' => esc_html__( 'Sidr', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is for easily creating responsive side menus, used for the Sidebar mobile menu style.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_dropdown_mobile_script'     => array(
				'label' => esc_html__( 'Drop Down Mobile', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is used for the Drop Down mobile menu style.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_fullscreen_mobile_script'   => array(
				'label' => esc_html__( 'Full Screen Mobile', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is used for the Full Screen mobile menu style.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_slick_script'               => array(
				'label' => esc_html__( 'Slick', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script is used for all the carousel of your site, gallerie images, WooCommerce single product images and thumbnails.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_smoothScroll_script'        => array(
				'label' => esc_html__( 'SmoothScroll', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script adds a smooth scrolling to the browser.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_superfish_script'           => array(
				'label' => esc_html__( 'Superfish', 'sunio-extra' ),
				'desc'  => esc_html__( 'This script adds usability enhancements to existing multi-level drop-down menus.', 'sunio-extra' ),
				'type'  => 'js',
			),
			'oe_wooAccountLinks_script'    => array(
				'label'     => esc_html__( 'WooCommerce Account Links', 'sunio-extra' ),
				'desc'      => esc_html__( 'This script is to switch between login/register in your account page.', 'sunio-extra' ),
				'type'      => 'js',
				'condition' => class_exists( 'WooCommerce' ),
			),
			'oe_wooGridList_script'         => array(
				'label'     => esc_html__( 'WooCommerce Grid/List Buttons', 'sunio-extra' ),
				'desc'      => esc_html__( 'This script is to switch between grid and list view on your WooCommerce catalog products.', 'sunio-extra' ),
				'type'      => 'js',
				'condition' => class_exists( 'WooCommerce' ),
			),
			'oe_wooQuantityButtons_script'  => array(
				'label'     => esc_html__( 'WooCommerce Quantity Buttons', 'sunio-extra' ),
				'desc'      => esc_html__( 'This script is to add a up and down button for the quantity input number on your WooCommerce single products and cart pages.', 'sunio-extra' ),
				'type'      => 'js',
				'condition' => class_exists( 'WooCommerce' ),
			),
			'oe_wooReviewsScroll_script'    => array(
				'label'     => esc_html__( 'WooCommerce Reviews Scroll', 'sunio-extra' ),
				'desc'      => esc_html__( 'This script is to show and scroll down to your review tab to your WooCommerce single products when you click on the review link.', 'sunio-extra' ),
				'type'      => 'js',
				'condition' => class_exists( 'WooCommerce' ),
			),
			...
			'oe_fontAwesome_style'            => array(
				'label' => esc_html__( 'Font Awesome Icons', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the font awesome icons.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_simpleLineIcons_style'        => array(
				'label' => esc_html__( 'Simple Line Icons', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the simple line icons.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_topBar_style'                 => array(
				'label' => esc_html__( 'Top Bar', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the top bar.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_header_style'                 => array(
				'label' => esc_html__( 'Header', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the header.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_transparentHeader_style'      => array(
				'label' => esc_html__( 'Transparent Header', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the transparent header style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_topHeader_style'              => array(
				'label' => esc_html__( 'Top Header', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the top header style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_fullScreenHeader_style'       => array(
				'label' => esc_html__( 'Full Screen Header', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the full screen header style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_centerHeader_style'           => array(
				'label' => esc_html__( 'Center Header', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the center header style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_mediumHeader_style'           => array(
				'label' => esc_html__( 'Medium Header', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the medium header style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_verticalHeader_style'         => array(
				'label' => esc_html__( 'Vertical Header', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the vertical header style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_customHeader_style'           => array(
				'label' => esc_html__( 'Custom Header', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the custom header style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_navigation_style'             => array(
				'label' => esc_html__( 'Navigation', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the navigation of the principal menu.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_menu_links_effect_style'      => array(
				'label' => esc_html__( 'Links Effect', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the links effect of the principal menu.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_socialMenu_style'             => array(
				'label' => esc_html__( 'Social Icons Menu', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the social icons in the navigation of the header.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_pageHeader_style'             => array(
				'label' => esc_html__( 'Page Header', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the page header (title).', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_blog_style'                   => array(
				'label' => esc_html__( 'Blog', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the blog and post formats.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_blogLarge_style'              => array(
				'label' => esc_html__( 'Blog Large Style', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the blog large style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_blogGrid_style'               => array(
				'label' => esc_html__( 'Blog Grid Style', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the blog grid style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_blogThumbnail_style'          => array(
				'label' => esc_html__( 'Blog Thumbnail Style', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the blog thumbnail style.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_singlePostPrevNext_style'     => array(
				'label' => esc_html__( 'Single Post Next/Prev Pagination', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the next/previous pagination on single post.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_singlePostAuthorBio_style'    => array(
				'label' => esc_html__( 'Single Post Author Box', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the author box on single post.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_singlePostRelatedPosts_style' => array(
				'label' => esc_html__( 'Single Post Related Posts', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the related posts on single post.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_sidebar_style'                => array(
				'label' => esc_html__( 'Sidebar', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the sidebar.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_comment_style'                => array(
				'label' => esc_html__( 'Comment', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the comments.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_pagination_style'             => array(
				'label' => esc_html__( 'Pagination', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the pagination.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_footerWidgets_style'          => array(
				'label' => esc_html__( 'Footer Widgets', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the footer widgets area.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_footerBottom_style'           => array(
				'label' => esc_html__( 'Footer Bottom', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the footer bottom area.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_searchResults_style'          => array(
				'label' => esc_html__( 'Search Results', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the search results page.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_scrollTop_style'              => array(
				'label' => esc_html__( 'Scroll Top Button', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the scroll top button.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_errorPage_style'              => array(
				'label' => esc_html__( '404 Page', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the 404 error page.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_responsive_style'             => array(
				'label' => esc_html__( 'Responsive', 'sunio-extra' ),
				'desc'  => esc_html__( 'This style is all the css for the responsive view.', 'sunio-extra' ),
				'type'  => 'css',
			),
			'oe_wooMenuCart_style'         	=> array(
				'label'     => esc_html__( 'WooCommerce Menu Cart', 'sunio-extra' ),
				'desc'      => esc_html__( 'This style is to display and hide your WooCommerce cart drop down in the navigation.', 'sunio-extra' ),
				'type'      => 'css',
				'condition' => class_exists( 'WooCommerce' ),
			),
			'oe_wooNav_style'         => array(
				'label'     => esc_html__( 'WooCommerce Navigation', 'sunio-extra' ),
				'desc'      => esc_html__( 'This style is for the single product navigation.', 'sunio-extra' ),
				'type'      => 'css',
				'condition' => class_exists( 'WooCommerce' ),
			),
			'oe_wooOffCanvas_style'         => array(
				'label'     => esc_html__( 'WooCommerce Off Canvas Filter', 'sunio-extra' ),
				'desc'      => esc_html__( 'This style is for the off canvas filter.', 'sunio-extra' ),
				'type'      => 'css',
				'condition' => class_exists( 'WooCommerce' ),
			),
			'oe_wooMobileCart_style'         => array(
				'label'     => esc_html__( 'WooCommerce Mobile Cart Sidebar', 'sunio-extra' ),
				'desc'      => esc_html__( 'This style is for the mini cart sidebar on mobile.', 'sunio-extra' ),
				'type'      => 'css',
				'condition' => class_exists( 'WooCommerce' ),
			),
			'oe_wooCategoriesWidget_style'         => array(
				'label'     => esc_html__( 'WooCommerce Categories Widget', 'sunio-extra' ),
				'desc'      => esc_html__( 'This style is for the WooCommerce categories widget.', 'sunio-extra' ),
				'type'      => 'css',
				'condition' => class_exists( 'WooCommerce' ),
			),
		);
	...
	public function add_page() {
		add_submenu_page(
			'sunio-panel',
			esc_html__( 'Scripts & Styles', 'sunio-extra' ),
			esc_html__( 'Scripts & Styles', 'sunio-extra' ),
			'manage_options',
			'sunio-panel-scripts',
	...
	public static function register_settings() {
		register_setting( 'oe_scripts_settings', 'oe_scripts_settings', array( 'sunio_Extra_Scripts_Panel', 'validate_settings' ) );
	}
	...
	public static function create_admin_page() {
		...
		<div class="wrap sunio-scripts-panel sunio-clr">

			<h1><?php esc_attr_e( 'Scripts & Styles Panel', 'sunio-extra' ); ?></h1>

			<div class="sunio-desc notice notice-warning">
				<p><?php esc_html_e( 'Disable scripts and styles that you do not need to improve the loading speed of your website.', 'sunio-extra' ); ?></p>
			</div>

			<form id="sunio-scripts-panel-form" method="post" action="options.php">

				<?php settings_fields( 'oe_scripts_settings' ); ?>

				<div class="sunio-modules">
					...
					<div class="modules-top clr">
						...
						<div class="owp-all-wrap">
							<p><?php esc_attr_e( 'Switch to check or un-check every scripts:', 'sunio-extra' ); ?></p>
							<div id="owp-switch">
						...
						<ul class="btn-switcher clr">
							<li class="active"><a href="#all"><?php esc_html_e( 'All', 'sunio-extra' ); ?></a></li>
							<li><a href="#js"><?php esc_html_e( 'JS', 'sunio-extra' ); ?></a></li>
							<li><a href="#css"><?php esc_html_e( 'CSS', 'sunio-extra' ); ?></a></li>
						</ul>
							...
							<div class="<?php echo esc_attr( $classes ); ?>" data-type="<?php echo esc_attr( $type ); ?>">
								...
								<div class="column-inner clr">
									...
									<div class="bottom-column">
										<label for="sunio-[<?php echo esc_attr( $key ); ?>]" class="title"><?php esc_attr_e( 'Enable or Disable', 'sunio-extra' ); ?></label>
										<div id="owp-switch">
										    <input type="checkbox" name="oe_scripts_settings[<?php echo esc_attr( $key ); ?>]" value="true" class="owp-checkbox" id="sunio-[<?php echo esc_attr( $key ); ?>]" <?php checked( $settings ); ?>>
										    <label for="sunio-[<?php echo esc_attr( $key ); ?>]"></label>
										</div>
									</div>
	...
	public static function admin_scripts( $hook ) {
		...
		if ( AZT_ADMIN_PANEL_HOOK_PREFIX . '-scripts' != $hook ) {
			return;
		}

		// CSS
		wp_enqueue_style( 'sunio-scripts-panel', plugins_url( '/assets/css/scripts.min.css', __FILE__ ) );

		// JS
		wp_enqueue_script( 'sunio-scripts-panel', plugins_url( '/assets/js/scripts.min.js', __FILE__ ), false, true );
	...
	public function generate_js() {
		...
		// Return if is not sunio or not writable
		...
		if ( ! $customSelect
			...
			// Minifying JS files
			$jsMignifier = sunio_Extra_JSMin::minify( $strJS );
	...
	public static function generate_css() {
		...
		require_once( AZT_PATH .'/includes/panel/scssphp/scss.inc.php' );
	...
	public static function enqueue_scripts() {
		...
		$enqueue_scripts = apply_filters( 'sunio_enqueue_generated_files', true );
		...
		if ( file_exists( self::get_file( 'js', 'path' ) ) ) {
			...
			wp_deregister_script( 'sunio-main' );
			wp_deregister_script( 'infinitescroll' );
			if ( OCEANWP_WOOCOMMERCE_ACTIVE ) {
				wp_deregister_script( 'sunio-woocommerce' );
			}

			// If the lightbox script is disabled
			if ( ! self::get_setting( 'oe_lightbox_script' ) ) {
				wp_deregister_script( 'magnific-popup' );
				wp_deregister_script( 'sunio-lightbox' );
			}

			// Enqueue the JS
			wp_enqueue_script( 'sunio-main', self::get_file( 'js', 'uri' ), array( 'jquery' ), $theme_version, true );

			// Localize array
			if ( class_exists( 'OCEANWP_Theme_Class' ) ) {
				wp_localize_script( 'sunio-main', 'sunioLocalize', OCEANWP_Theme_Class::localize_array() );
			}
		...
		if ( file_exists( self::get_file( 'css', 'path' ) ) ) {
			...
			wp_deregister_style( 'sunio-style' );
			...
			if ( OCEANWP_WOOCOMMERCE_ACTIVE ) {
				wp_deregister_style( 'sunio-woocommerce' );
			}

			// Enqueue the CSS
			wp_enqueue_style( 'sunio-style', self::get_file( 'css', 'uri' ), false, $theme_version );
	...
	private static function get_file( $return = 'js', $target = 'path' ) {
		...
		$folder_path 	= $upload_dir['basedir'] . DIRECTORY_SEPARATOR . 'sunio';
		...
		$js_uri 		= trailingslashit( $uri_folder ) . 'sunio/' . $js_file;
		$css_uri 		= trailingslashit( $uri_folder ) . 'sunio/' . $css_file;
