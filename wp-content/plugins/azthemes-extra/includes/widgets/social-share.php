...
if ( ! class_exists( 'sunio_Extra_Social_Share_Widget' ) ) {
	class sunio_Extra_Social_Share_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'sunio_social_share',
				esc_html__( '&raquo; Social Share', 'sunio-extra' ),
				array(
					'classname'   => 'widget-sunio-social-share social-share',
					'description' => esc_html__( 'Display social sharing buttons on your sidebar.', 'sunio-extra' ),
		...
		public function social_array() {
			...
			// Array
			$return = apply_filters( 'sunio_social_share_buttons', array(
				'twitter' => array(
					'name' 	=> 'Twitter',
					'title' => esc_html__( 'Share on Twitter', 'sunio-extra' ),
				...
				'facebook' => array(
					'name' 	=> 'Facebook',
					'title' => esc_html__( 'Share on Facebook', 'sunio-extra' ),
				...
				'googleplus' => array(
					'name' 	=> 'Google+',
					'title' => esc_html__( 'Share on Google+', 'sunio-extra' ),
				...
				'pinterest' => array(
					'name' 	=> 'Pinterest',
					'title' => esc_html__( 'Share on Pinterest', 'sunio-extra' ),
				...
				'linkedin' => array(
					'name' 	=> 'LinkedIn',
					'title' => esc_html__( 'Share on LinkedIn', 'sunio-extra' ),
				...
				'viber' => array(
					'name' 	=> 'Viber',
					'title' => esc_html__( 'Share on Viber', 'sunio-extra' ),
				...
				'vk' => array(
					'name' 	=> 'VK',
					'title' => esc_html__( 'Share on VK', 'sunio-extra' ),
				...
				'reddit' => array(
					'name' 	=> 'Reddit',
					'title' => esc_html__( 'Share on Reddit', 'sunio-extra' ),
				...
				'tumblr' => array(
					'name' 	=> 'Tumblr',
					'title' => esc_html__( 'Share on Tumblr', 'sunio-extra' ),
				...
				'viadeo' => array(
					'name' 	=> 'Viadeo',
					'title' => esc_html__( 'Share on Viadeo', 'sunio-extra' ),
		...
		public function form( $instance ) {
			...
			$instance = wp_parse_args( ( array ) $instance, array(
				'title'           	 => esc_attr__( 'Please share this', 'sunio-extra' ),
				'style' 	  		 => esc_html__( 'Minimal', 'sunio-extra' ),
				'border_radius'   	 => '',
				'border_color'   	 => '',
				'bg_color'   	     => '',
				'color'   	         => '',
			...
			<p>
				...
				<select class='widefat' name="<?php echo esc_attr( $this->get_field_name( 'style' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>">
					<option value="minimal" <?php selected( $instance['style'], 'minimal' ) ?>><?php esc_html_e( 'Minimal', 'sunio-extra' ); ?></option>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'border_color' ) ); ?>"><?php esc_html_e( 'Minimal Style: Border Color', 'sunio-extra' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'bg_color' ) ); ?>"><?php esc_html_e( 'Minimal Style: Background Color', 'sunio-extra' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'color' ) ); ?>"><?php esc_html_e( 'Minimal Style: Color', 'sunio-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_username' ) ); ?>"><?php esc_html_e( 'Twitter Username', 'sunio-extra' ); ?>:</label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'social_name' ); ?>"><?php esc_html_e( 'Show Social Name', 'sunio-extra' ); ?></label>
			</p>

			<h3><?php esc_html_e( 'Social Share','sunio-extra' ); ?></h3>
			<?php
			// Social array
		...
		public function colors( $args, $instance ) {
			...
			if ( $bg_color
				...
				|| $border_color ) : ?>
				<style>
					#<?php echo $id; ?>.widget-sunio-social-share ul li a {
        ...
        public function scripts() {
            ...
            if ( is_active_widget( '', '', 'sunio_social_share' ) ) {
            	wp_enqueue_script( 'oe-social-share', AZT_URL . 'includes/widgets/js/share.min.js', array( 'jquery' ), false, true );
            }
        }

	}
}
register_widget( 'sunio_Extra_Social_Share_Widget' );