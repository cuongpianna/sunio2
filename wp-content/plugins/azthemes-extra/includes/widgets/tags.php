...
if ( ! class_exists( 'sunio_Extra_Tags_Widget' ) ) {
	class sunio_Extra_Tags_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'sunio_tags',
				esc_html__( '&raquo; Tags Cloud', 'sunio-extra' ),
				array(
					'classname'   => 'widget-sunio-tags tags-widget',
					'description' => esc_html__( 'A cloud of your most used tags.', 'sunio-extra' ),
		...
		public function form( $instance ) {
			...
			case 0:
				echo '<p>' . esc_html__( 'The tag cloud will not be displayed since there are no taxonomies that support the tag cloud widget.', 'sunio-extra' ) . '</p>';
				printf( $input, '' );
				break;
			...
			default:
				printf(
					...
					$id,
					esc_html__( 'Taxonomy:', 'sunio-extra' ),
					$name
				);
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'padding' ) ); ?>"><?php esc_html_e( 'Padding:', 'sunio-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'bg_color' ) ); ?>"><?php esc_html_e( 'Background Color:', 'sunio-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'bg_hover_color' ) ); ?>"><?php esc_html_e( 'Background Hover Color:', 'sunio-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'link_color' ) ); ?>"><?php esc_html_e( 'Link Color:', 'sunio-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'link_hover_color' ) ); ?>"><?php esc_html_e( 'Link Hover Color:', 'sunio-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'border_color' ) ); ?>"><?php esc_html_e( 'Border Color:', 'sunio-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'border_hover_color' ) ); ?>"><?php esc_html_e( 'Border Hover Color:', 'sunio-extra' ); ?></label>
			...
			<p>
				...
				<select class="widget-select widefat" name="<?php echo esc_attr( $this->get_field_name('text_transform') ); ?>" id="<?php echo esc_attr( $this->get_field_id('position') ); ?>">
					...
					<option value="none" <?php selected( $instance['text_transform'], 'none' ) ?>><?php esc_html_e( 'None', 'sunio-extra' ); ?></option>
				</select>
			</p>
...
register_widget( 'sunio_Extra_Tags_Widget' );