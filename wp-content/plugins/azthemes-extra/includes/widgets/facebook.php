...
if ( ! class_exists( 'sunio_Extra_Facebook_Widget' ) ) {
	class sunio_Extra_Facebook_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'sunio_facebook',
				esc_html__( '&raquo; Facebook Like Box', 'sunio-extra' ),
				array(
					'classname'   => 'widget_facebook_likebox',
					'description' => esc_html__( 'Display a Facebook Like Box to connect visitors to your Facebook Page.', 'sunio-extra' ),
		...
		public function widget( $args, $instance ) {
			...
			$like_bg_colour          = apply_filters( 'sunio_fb_likebox_bg', ( 'dark' == $like_args['colorscheme'] ? '#000' : '#fff' ), $like_args['colorscheme'] );
			...
			echo $args['before_widget'];
				...
				if ( ! empty( $title ) ) :
					...
					echo apply_filters( 'sunio_facebook_likebox_title', $likebox_widget_title, $title, $page_url );
			...
			do_action( 'sunio_stats_extra', 'widget', 'facebook-likebox' );
		}
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'href' ) ); ?>"><?php esc_html_e( 'Facebook Page URL', 'sunio-extra' ); ?></label>
				...
				<br />
				<small><?php esc_html_e( 'The Like Box only works with ', 'sunio-extra' ); ?><a href="http://www.facebook.com/help/?faq=174987089221178" target="_blank"><?php esc_html_e( 'Facebook Pages', 'sunio-extra' ); ?></a></small>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'width' ) ); ?>"><?php esc_html_e( 'Width', 'sunio-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'height' ) ); ?>"><?php esc_html_e( 'Height', 'sunio-extra' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'colorscheme' ) ); ?>"><?php esc_html_e( 'Color Scheme', 'sunio-extra' ); ?></label>
				<select name="<?php echo esc_attr( $this->get_field_name( 'colorscheme' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'colorscheme' ) ); ?>">
					<option value="light" <?php selected( $like_args['colorscheme'], 'light' ); ?>><?php esc_html_e( 'Light', 'sunio-extra' ); ?></option>
					<option value="dark" <?php selected( $like_args['colorscheme'], 'dark' ); ?>><?php esc_html_e( 'Dark', 'sunio-extra' ); ?></option>
				</select>
			</p>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'show_faces' ) ); ?>">
					...
					<?php esc_html_e( 'Show Faces', 'sunio-extra' ); ?>
					<br />
					<small><?php esc_html_e( 'Show profile photos in the plugin.', 'sunio-extra' ); ?></small>
				</label>
			</p>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'stream' ) ); ?>">
					...
					<?php esc_html_e( 'Show Stream', 'sunio-extra' ); ?>
					<br />
					<small><?php esc_html_e( 'Show the profile stream for the public profile.', 'sunio-extra' ); ?></small>
				</label>
			</p>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'show_border' ) ); ?>">
					...
					<?php esc_html_e( 'Show Border', 'sunio-extra' ); ?>
					<br />
					<small><?php esc_html_e( 'Show a border around the plugin.', 'sunio-extra' ); ?></small>
				</label>
			</p>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'force_wall' ) ); ?>">
					...
					<?php esc_html_e( 'Show Wall', 'sunio-extra' ); ?>
					<br />
					<small><?php esc_html_e( 'Show the wall for a Places page rather than friend activity.', 'sunio-extra' ); ?></small>
				</label>
			</p>
		...
		public function get_default_args() {
			...
			return apply_filters( 'sunio_facebook_likebox_defaults', $defaults );
		}
...
register_widget( 'sunio_Extra_Facebook_Widget' );